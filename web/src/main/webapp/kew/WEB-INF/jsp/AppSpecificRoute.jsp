        ...
        <td>
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bord-r-t">
            <tr>
			  ...
			  <td class="datacell">
				<span><html-el:text property="appSpecificRouteRecipient.id" value="${KewRoutingKualiForm.appSpecificRouteRecipient.id}"/></span>
                <kul:checkErrors keyMatch="appSpecificRouteRecipient.id" />
                <c:if test="${hasErrors}">
                  <kul:fieldShowErrorIcon />
                </c:if>
				<c:if test="${KewRoutingKualiForm.appSpecificRouteRecipientType == 'person'}">
				  <c:set var="personLookup" value="display:inline;"/>
				  <c:set var="workgroupLookup" value="display:none;"/>
				</c:if>

				<c:if test="${KewRoutingKualiForm.appSpecificRouteRecipientType == 'workgroup'}">
			  ...
			  <td class="datacell">
	 		  <%-- <html-el:select property="appSpecificRouteRecipient.actionRequested"> --%>
 	 			<html-el:select property="appSpecificRouteActionRequestCd" value="${KewRoutingKualiForm.appSpecificRouteActionRequestCd}">
