...
/**
 * Implements the "sureturntopreviousnode" action 
 * @author Kuali Rice Team (kuali-rice@googlegroups.com)
 */
public class SUReturnToPreviousNodeActionHandler implements ActionHandler {
    /**
     ...
     * @param args String nodeName, Boolean runPostProcessor
     */
    public void invoke(DocumentRouteHeaderValue routeHeader, WorkflowUser user, String annotation, Object... args) throws InvalidActionTakenException, EdenUserNotFoundException {
        SuperUserReturnToPreviousNodeAction action = new SuperUserReturnToPreviousNodeAction(routeHeader, user, annotation, (Boolean) args[1], (String) args[0]);
