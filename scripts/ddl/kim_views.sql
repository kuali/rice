...
FROM KRIM_ROLE_T KRIM_ROLE_T 
		LEFT OUTER JOIN KRIM_ROLE_PRNCPL_T KRIM_ROLE_PRNCPL_T 
		ON KRIM_ROLE_T.ROLE_ID = KRIM_ROLE_PRNCPL_T.ROLE_ID 
			LEFT OUTER JOIN KRIM_ROLE_MBR_ATTR_DATA_T KRIM_ROLE_MBR_ATTR_DATA_T 
			ON KRIM_ROLE_PRNCPL_T.ROLE_MBR_ID = KRIM_ROLE_MBR_ATTR_DATA_T.
			TARGET_PRIMARY_KEY 
				...
				KIM_ATTR_DEFN_ID 
					...
					ON KRIM_ROLE_PRNCPL_T.PRNCPL_ID = KRIM_PRNCPL_T.PRNCPL_ID 
