...
public abstract class KOMDaoTestBase extends KOMTestCase {
	...
	/**
     * This method should be overridden and implemented to perform a setup of any dependent objects that a business object
	...
	/**
     * This method must be implemented to return true if a record was properly retrieved from the database.
     * 
     * @return boolean
     */
	...
	/**
     * This method should be implemented to retrieve the objects that were just updated, and validate that their changes took
     * effect.
     * 
     * @return boolean
     */
	...
	/**
     * This method must be implemented to return true if a record was properly deleted from the database.
     * 
     * @return boolean
     */
	...
	/**
     * This method must be implemented to return true if the previously deleted records cannot be found.
     * 
     * @return boolean
     */
