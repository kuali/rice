...
public class EntityResidencyStatusHistoryBo extends EntityResidencyTypeBo implements CodedAttributeHistoryBoContract {
    ...
    public static CodedAttributeHistory to(EntityResidencyStatusHistoryBo bo) {
        if (bo == null) {
            return null;
        }
    ...
    public static EntityResidencyStatusHistoryBo from(CodedAttributeHistory immutable) {
        return CodedAttributeHistoryBoUtil.from(EntityResidencyStatusHistoryBo.class, immutable);
    }

    public static EntityResidencyStatusHistoryBo from(CodedAttribute immutable,
            Timestamp fromDate,
            Timestamp toDate) {
        return CodedAttributeHistoryBoUtil.from(EntityResidencyStatusHistoryBo.class, immutable, fromDate, toDate);
    }
}
