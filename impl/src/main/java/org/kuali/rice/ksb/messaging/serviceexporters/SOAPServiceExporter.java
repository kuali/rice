...
public class SOAPServiceExporter implements ServiceExporter {
	...
	public ServerSideRemotedServiceHolder getServiceExporter(Object serviceImpl) {
		try {
			...
			serviceExporter.getInHandlers().add(new XFireWSS4JInHandler(serviceInfo));
			...
			serviceExporter.getOutHandlers().add(new XFireWSS4JOutHandler(serviceInfo));
			...
			serviceExporter.getFaultHandlers().add(new XFireWSS4JOutHandler(serviceInfo));
