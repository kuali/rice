 ...
 */
public class DemoRoutingReportAft extends WebDriverLegacyITBase {
     ...
     */
    public static final String BOOKMARK_URL = AutomatedFunctionalTestUtils.PORTAL + "?channelTitle=Routing%20Report&channelUrl="
            + WebDriverUtils.getBaseUrlString() + "/kew/RoutingReport.do?returnLocation=" + AutomatedFunctionalTestUtils.PORTAL;
    ...
    protected void testDemoRoutingReport() throws Exception { 
...
//      selectFrameIframePortlet();
    ...
    @Test
    public void testDemoRoutingReportBookmark() throws Exception {
        testDemoRoutingReport();
        passed();
    }

    @Test
    public void testDemoRoutingReportNav() throws Exception {
        testDemoRoutingReport();
        passed();
    }
}
