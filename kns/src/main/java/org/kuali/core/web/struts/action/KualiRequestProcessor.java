...
public class KualiRequestProcessor extends RequestProcessor {
    ...
    /**
     * override of the pre process for all struts requests which will ensure that we have the appropriate state for user sessions
     * for all of our requests, also populating the GlobalVariables class with our UserSession for convenience to the non web layer
     * based classes and implementations
     */
    @Override
     ...
     *
     * <p>A transaction is started prior to the execution of the action.  This allows for the action code to execute efficiently
     * without the need for using PROPAGATION_SUPPORTS in the transaction definitions.  The PROPAGATION_SUPPORTS propagation type
     * does not work well with JTA.
     */
    @Override
     ...
     *
     * @see org.apache.struts.action.RequestProcessor#processException(HttpServletRequest, HttpServletResponse, Exception,
