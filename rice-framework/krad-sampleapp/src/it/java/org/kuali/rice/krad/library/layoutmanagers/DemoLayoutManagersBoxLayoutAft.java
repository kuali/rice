 ...
 */
public class DemoLayoutManagersBoxLayoutAft extends AutomatedFunctionalTestBase {

    /**
     * /kr-krad/kradsampleapp?viewId=Demo-BoxLayoutManager-View&methodToCall=start
     */
    public static final String BOOKMARK_URL = "/kr-krad/kradsampleapp?viewId=Demo-BoxLayoutManager-View&methodToCall=start";
    ...
    protected void testLayoutManagersBoxLayoutItemCSS() throws Exception {
        ...
        assertElementPresentByXpath("//div[@data-parent='Demo-BoxLayoutManager-Example6']/div/div/input[@name='inputField21' and @class='uif-textControl']");
    }
