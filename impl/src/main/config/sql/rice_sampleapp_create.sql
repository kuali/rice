...
-- Concatenating rice_db_bootstrap.sql
...
CREATE TABLE FS_ADHOC_RTE_ACTN_RECP_T (
     ...
     CONSTRAINT FS_ADHOC_RTE_ACTN_RECP_TP1 PRIMARY KEY (ACTN_RQST_RECP_TYP_CD,ACTN_RQST_CD,ACTN_RQST_RECP_ID,FDOC_NBR),
...
/
-- table name used in DocumentAuthorizerBaseTest class
...
CREATE TABLE SH_NTE_T (
        ...
        NTE_AUTH_ID                    VARCHAR2(30) CONSTRAINT SH_NTE_TN5 NOT NULL,
...
/
CREATE INDEX EN_DOC_TYP_TI6
      ON EN_DOC_TYP_T (DOC_TYP_NM)
/
CREATE INDEX EN_DOC_TYP_TI7
      ON EN_DOC_TYP_T (RPT_WRKGRP_ID)
/
