...
public class UniversalUserDaoJpa implements UniversalUserDao {
	...
	public UniversalUser getUser(org.kuali.rice.kns.bo.user.UserId userId) throws UserNotFoundException {
		...
		if (userId instanceof org.kuali.rice.kns.bo.user.AuthenticationUserId) {
			criteria.eq("personUserIdentifier", StringUtils.upperCase(((org.kuali.rice.kns.bo.user.AuthenticationUserId) userId).getAuthenticationId()));
		}
		if (userId instanceof org.kuali.rice.kns.bo.user.PersonPayrollId) {
			criteria.eq("personPayrollIdentifier", ((org.kuali.rice.kns.bo.user.PersonPayrollId) userId).getPayrollId());
		}
		if (userId instanceof org.kuali.rice.kns.bo.user.UuId) {
			criteria.eq("personUniversalIdentifier", ((org.kuali.rice.kns.bo.user.UuId) userId).getUuId());
		}
		if (userId instanceof org.kuali.rice.kns.bo.user.PersonTaxId) {
			criteria.eq("personTaxIdentifier", ((org.kuali.rice.kns.bo.user.PersonTaxId) userId).getTaxId());
		}
