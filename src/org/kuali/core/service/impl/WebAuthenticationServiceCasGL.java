...
/**
 * This class is used to perform the webAuthentication Service when using the IU Cas Filter for GL testing.
 * 
 * 
 */
public class WebAuthenticationServiceCasGL implements WebAuthenticationService {
