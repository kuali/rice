 ...
 */
package org.kuali.rice.kew.routetemplate.dao.impl;
...
public class RuleTemplateAttributeDAOOjbImpl extends PersistenceBrokerDaoSupport implements RuleTemplateAttributeDAO {
  ...
  /*
   * (non-Javadoc)
   * @see org.kuali.rice.kew.routetemplate.dao.RuleTemplateAttributeDAO#delete(java.lang.Long)
   */
...
//  }
  ...
  /*
   * (non-Javadoc)
   * @see org.kuali.rice.kew.routetemplate.dao.RuleTemplateAttributeDAO#findByRuleTemplateAttributeId(java.lang.Long)
   */
