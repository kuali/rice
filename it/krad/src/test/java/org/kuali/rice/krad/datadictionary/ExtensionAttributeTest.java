...
public class ExtensionAttributeTest extends KRADTestCase {
	...
	public void setUp() throws Exception {
        ...
        dd.addConfigFileLocation("file:" + getBaseDir() + "/../../impl/src/main/resources/org/kuali/rice/krad/uif/UifMiscDefinitions.xml");
		...
		dd.addConfigFileLocation("file:" + getBaseDir() + "/../../impl/src/main/resources/org/kuali/rice/krad/document/datadictionary");
		...
		dd.addConfigFileLocation("file:" + getBaseDir() + "/../../impl/src/main/resources/org/kuali/rice/kim/bo/datadictionary/RoleBo.xml");
