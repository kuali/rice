...
public class DocumentAuthorizerBaseTest extends KNSTestBase {
    ...
    protected UniversalUser getWorkflowPessimisticLockOwnerUser() {
        ...
        try {
            return new UniversalUser(KNSServiceLocator.getUniversalUserService().getUniversalUser(new AuthenticationUserId(networkId)));
    ...
    public void testEstablishLocks_DefaultDocumentAuthorizerBase() throws Exception {
        ...
        Map newEditMode = documentAuthorizer.establishLocks(document, oldEditMode, getNonSuperUser());
        ...
        oldEditMode.put(AuthorizationConstants.EditMode.UNVIEWABLE, testString);
        newEditMode = documentAuthorizer.establishLocks(document, oldEditMode, getNonSuperUser());
        assertEquals("Lock count is incorrect", originalExpectedLockCount + expectedLockCountIncrease, document.getPessimisticLocks().size());
        assertEquals("Establish locks method returned invalid number of edit modes", oldEditMode.size(), newEditMode.size());
    ...
    public void testEstablishLocks_CustomDocumentAuthorizerBase() throws Exception {
        ...
        expectedLockDescriptor = lockDescriptor3;
        GlobalVariables.getUserSession().addObject(TestDocumentAuthorizerBase.USER_SESSION_OBJECT_KEY, (Object) expectedLockDescriptor);
        UniversalUser user = getWorkflowPessimisticLockOwnerUser();
    ...
    public void testHasPreRouteEditAuthorization() throws Exception {
        ...
        UniversalUser initiatorUser = getNonSuperUser();
        UniversalUser authorizerUser = getNonSuperUser();
    ...
    public void testGetDocumentActionFlagsUsingPessimisticLocking() throws Exception {
        ...
        DocumentFormPlaceholder formDummy = implementDocumentAuthorizerMethods(lockDocumentAuthorizer, document, new UniversalUser(GlobalVariables.getUserSession().getUniversalUser()));
     ...
     */
    private DocumentFormPlaceholder implementDocumentAuthorizerMethods(PessimisticLockTestDocumentAuthorizer documentAuthorizer, Document document, UniversalUser kualiUser) {
    ...
    private UniversalUser getSecondNonSuperUser() {
        return new UniversalUser(NONSUPER_2_UNIVERSAL, NONSUPER_2_USER, false);
    }
    ...
    private class MockWorkflowDocument extends org.kuali.rice.kns.impls.MockWorkflowDocument {
    ...
    private class UniversalUser extends org.kuali.rice.kns.bo.user.UniversalUser {
        ...
        public String toString() {
            return ((supervisor) ? "Supervisor " : "") + "User (" + getPersonUserIdentifier() + ")";
        }
