...
public class TravelCompany extends DataObjectBase implements Serializable {
    ...
    private String travelCompanyCd;
    ...
    public String getTravelCompanyCd() {
        return travelCompanyCd;
    }

    public void setTravelCompanyCd(String travelCompanyCd) {
        this.travelCompanyCd = travelCompanyCd;
    }
