	...
	if (!c.ui.version) {
		...
		c.extend(c.expr[":"], {
			...
			focusable : function(a) {
				...
				return (/input|select|textarea|button|object/.test(b) ? !a.disabled
...
(function(b, j) {
	...
	b.widget.bridge = function(a, c) {
		b.fn[a] = function(d) {
			var e = typeof d === "string", f = Array.prototype.slice.call(arguments,
					1), h = this;
			...
			e ? this.each(function() {
				var g = b.data(this, a);
				if (!g)
					throw "cannot call methods on " + a
							+ " prior to initialization; attempted to call method '" + d
							+ "'";
				if (!b.isFunction(g[d]))
			...
			.widget(
					"ui.mouse",
					{
						...
						_mouseDown : function(a) {
							...
							if (!a.originalEvent.mouseHandled) {
								...
								var b = this, e = a.which == 1, f = typeof this.options.cancel == "string" ? c(
										a.target).parents().add(a.target).filter(
						...
						_mouseMove : function(a) {
							...
							if (this._mouseDistanceMet(a) && this._mouseDelayMet(a))
								(this._mouseStarted = this._mouseStart(this._mouseDownEvent, a) !== false) ? this
										._mouseDrag(a)
										: this._mouseUp(a);
...
(function(c) {
	...
	c.fn.position = function(b) {
		...
		c.each([ "my", "at" ], function() {
			var f = (b[this] || "").split(" ");
			if (f.length === 1)
				f = n.test(f[0]) ? f.concat([ "center" ]) : o.test(f[0]) ? [ "center" ]
		...
		return this.each(function() {
			var f = c(this), l = f.outerWidth(), m = f.outerHeight(), p = parseInt(c
					.curCSS(this, "marginLeft", true)) || 0, q = parseInt(c.curCSS(this,
					"marginTop", true)) || 0, v = l + p
					+ parseInt(c.curCSS(this, "marginRight", true)) || 0, w = m + q
					+ parseInt(c.curCSS(this, "marginBottom", true)) || 0, i = c.extend(
					{}, j), r;
			if (b.my[0] === "right")
				i.left -= l;
		...
		fit : {
			...
			top : function(b, a) {
				...
				d = a.collisionPosition.top + a.collisionHeight - d.height()
						- d.scrollTop();
				b.top = d > 0 ? b.top - d : Math.max(b.top - a.collisionPosition.top,
						b.top)
			}
		},
		flip : {
			left : function(b, a) {
				if (a.at[0] !== "center") {
					...
					b.left += a.collisionPosition.left < 0 ? g + e + h : d > 0 ? g + e
							+ h : 0
				}
			},
			top : function(b, a) {
				if (a.at[1] !== "center") {
					...
					b.top += a.collisionPosition.top < 0 ? g + e + h : d > 0 ? g + e + h
							: 0
				}
			}
		}
	...
	if (!c.offset.setOffset) {
		c.offset.setOffset = function(b, a) {
			...
			var d = c(b), g = d.offset(), e = parseInt(c.curCSS(b, "top", true), 10) || 0, h = parseInt(
					c.curCSS(b, "left", true), 10) || 0;
			g = {
				top : a.top - g.top + e,
					...
					d.ui.mouse,
					{
						...
						_createHelper : function(a) {
							...
							a = d.isFunction(b.helper) ? d(b.helper.apply(this.element[0],
									[ a ])) : b.helper == "clone" ? this.element.clone()
									: this.element;
						...
						_setContainment : function() {
							...
							if (!/^(document|window|parent)$/.test(a.containment)
								...
								if (b) {
									...
									this.containment = [
											a.left + (parseInt(d(b).css("borderLeftWidth"), 10) || 0)
											...
											a.top + (parseInt(d(b).css("borderTopWidth"), 10) || 0)
													...
													- this.margins.top,
											a.left
													+ (c ? Math.max(b.scrollWidth, b.offsetWidth)
															: b.offsetWidth)
													- (parseInt(d(b).css("borderLeftWidth"), 10) || 0)
													- (parseInt(d(b).css("paddingRight"), 10) || 0)
													- this.helperProportions.width - this.margins.left,
											a.top
													+ (c ? Math.max(b.scrollHeight, b.offsetHeight)
															: b.offsetHeight)
							...
							if (this.originalPosition) {
								...
								if (b.grid) {
									g = this.originalPageY
											...
											* b.grid[1];
									g = this.containment ? !(g - this.offset.click.top < this.containment[1] || g
											- this.offset.click.top > this.containment[3]) ? g : !(g
									...
									e = this.originalPageX
											...
											* b.grid[0];
									e = this.containment ? !(e - this.offset.click.left < this.containment[0] || e
											- this.offset.click.left > this.containment[2]) ? e : !(e
			...
			d.each(c.sortables, function() {
				...
				if (this.instance._intersectsWith(this.instance.containerCache)) {
					if (!this.instance.isOver) {
						...
						this.instance.currentItem = d(f).clone().appendTo(
						...
						start : function() {
							...
							d(
									b.snap.constructor != String ? b.snap.items
											|| ":data(draggable)" : b.snap).each(function() {
							...
							for ( var c = d(this).data("draggable"), f = c.options, e = f.snapTolerance, g = b.offset.left, n = g
								...
								if (i - e < g && g < k + e && j - e < m && m < l + e
									...
									if (!c.snapElements[h].snapping && (p || q || r || s || t))
										c.options.snap.snap
												&& c.options.snap.snap.call(c.element, a, d.extend(c
														._uiHash(), {
									...
									c.snapElements[h].snapping
											...
											&& c.options.snap.release.call(c.element, a, d.extend(c
													._uiHash(), {
												snapItem : c.snapElements[h].item
											}));
					...
					"ui.droppable",
					{
						...
						_drop : function(a, b) {
							...
							if (!c || (c.currentItem || c.element)[0] == this.element[0])
								return false;
							var e = false;
							this.element.find(":data(droppable)").not(
									...
									function() {
										...
										if (g.options.greedy
												...
												&& g.accept.call(g.element[0], c.currentItem
														|| c.element) && d.ui.intersect(c, d.extend(g, {
	...
	d.ui.ddmanager = {
		...
		prepareOffsets : function(a, b) {
			var c = d.ui.ddmanager.droppables[a.options.scope] || [], e = b ? b.type
					: null, g = (a.currentItem || a.element).find(":data(droppable)")
					.andSelf(), f = 0;
			a: for (; f < c.length; f++)
								...
								for ( var b = this.helper || this.element, a = 0; a < this._proportionallyResizeElements.length; a++) {
									...
									if (!this.borderDif) {
										var d = [ c.css("borderTopWidth"),
												c.css("borderRightWidth"), c.css("borderBottomWidth"),
												c.css("borderLeftWidth") ], f = [ c.css("paddingTop"),
												c.css("paddingRight"), c.css("paddingBottom"),
												c.css("paddingLeft") ];
			...
			.add(
					...
					"alsoResize",
					{
						...
						resize : function(b, a) {
							...
							typeof b.alsoResize == "object" && !b.alsoResize.nodeType ? e
									.each(b.alsoResize, function(i, j) {
										h(i, j)
									}) : h(b.alsoResize)
						},
						stop : function() {
					...
					"containment",
					{
						...
						resize : function(b) {
							...
							if (f.top < (a._helper ? d.top : 0)) {
								a.size.height += a._helper ? a.position.top - d.top
										: a.position.top;
								if (b)
					...
					e.ui.mouse,
					{
						...
						_mouseStart : function(c) {
							...
							if (!this.options.disabled) {
								...
								e(c.target).parents().andSelf().each(
										function() {
											var b = e.data(this, "selectable-item");
											if (b) {
												var g = !c.metaKey
												...
												b.$element.removeClass(
														g ? "ui-unselecting" : "ui-selected").addClass(
			...
			.widget(
					...
					d.ui.mouse,
					{
							...
							for (b = this.items.length - 1; b >= 0; b--) {
								...
								if (f)
									if (e != this.currentItem[0]
											...
											&& (this.options.type == "semi-dynamic" ? !d.ui.contains(
													this.element[0], e) : true)) {
						...
						cancel : function() {
							...
							if (this.dragging) {
								this._mouseUp();
								this.options.helper == "original" ? this.currentItem.css(
										this._storedCSS).removeClass("ui-sortable-helper")
							...
							this.domPosition.prev ? d(this.domPosition.prev).after(
									this.currentItem) : d(this.domPosition.parent).prepend(
									this.currentItem);
							return this
						},
						...
						_intersectsWith : function(a) {
							...
							return this.options.tolerance == "pointer"
									...
									&& this.helperProportions[this.floating ? "width" : "height"] > a[this.floating ? "width"
											: "height"] ? j : g < b + this.helperProportions.width
									/ 2
						...
						_intersectsWithPointer : function(a) {
							...
							if (!b)
								return false;
							return this.floating ? c && c == "right" || a == "down" ? 2 : 1
									: a && (a == "down" ? 2 : 1)
						},
						_intersectsWithSides : function(a) {
							...
							return this.floating && e ? e == "right" && a || e == "left"
									&& !a : c && (c == "down" && b || c == "up" && !b)
						},
								...
								for (a = e.length - 1; a >= 0; a--)
									for ( var f = d(e[a]), g = f.length - 1; g >= 0; g--) {
										...
										if (h && h != this && !h.options.disabled)
											c.push([
													d.isFunction(h.options.items) ? h.options.items
															.call(h.element) : d(h.options.items, h.element)
															.not(".ui-sortable-helper").not(
																	".ui-sortable-placeholder"), h ])
									}
							c.push([
									d.isFunction(this.options.items) ? this.options.items.call(
											...
											}) : d(this.options.items, this.element).not(
								...
								for ( var f = e.length - 1; f >= 0; f--)
									for ( var g = d(e[f]), h = g.length - 1; h >= 0; h--) {
										...
										if (i && i != this && !i.options.disabled) {
											c.push([
													d.isFunction(i.options.items) ? i.options.items.call(
															i.element[0], a, {
																item : this.currentItem
										...
										if (!(e && !c.forcePlaceholderSize)) {
											g.height()
													|| g.height(b.currentItem.innerHeight()
															- parseInt(b.currentItem.css("paddingTop") || 0,
																	10)
															- parseInt(
																	b.currentItem.css("paddingBottom") || 0, 10));
											g.width()
													|| g.width(b.currentItem.innerWidth()
															- parseInt(b.currentItem.css("paddingLeft") || 0,
																	10)
															- parseInt(
																	b.currentItem.css("paddingRight") || 0, 10))
										}
									}
								}
							}
							...
							if (b)
								if (this.containers.length === 1) {
									...
									if (e || this.options.dropOnEmpty) {
										...
										this._trigger("change", a, this._uiHash());
										this.containers[c]
												._trigger("change", a, this._uiHash(this));
						...
						_createHelper : function(a) {
							...
							a = d.isFunction(b.helper) ? d(b.helper.apply(this.element[0], [
									a, this.currentItem ]))
									: b.helper == "clone" ? this.currentItem.clone()
											: this.currentItem;
							a.parents("body").length
							...
							return {
								top : b.top
										...
										* a
										+ this.offset.parent.top
										* a
										- (d.browser.safari && this.cssPosition == "fixed" ? 0
												: (this.cssPosition == "fixed" ? -this.scrollParent
														.scrollTop() : e ? 0 : c.scrollTop())
														* a),
								left : b.left
										+ this.offset.relative.left
										* a
							...
							if (this.originalPosition) {
								...
								if (b.grid) {
									...
									f = this.originalPageX
											...
											* b.grid[0];
									f = this.containment ? !(f - this.offset.click.left < this.containment[0] || f
											- this.offset.click.left > this.containment[2]) ? f : !(f
						...
						_clear : function(a, b) {
							...
							if ((this.fromOutside
									|| this.domPosition.prev != this.currentItem.prev().not(
						...
						_create : function() {
							...
							if (b.navigation) {
								...
								if (d.length) {
									...
									a.active = f.length ? f : d.closest(".ui-accordion-content")
											.prev()
								}
							}
								...
								if (a.target) {
									...
									if (!(this.running || !d.collapsible && b)) {
										this.active.removeClass("ui-state-active ui-corner-top")
												.addClass("ui-state-default ui-corner-all").children(
														".ui-icon").removeClass(d.icons.headerSelected)
												.addClass(d.icons.header);
										if (!b) {
											a.removeClass("ui-state-default ui-corner-all").addClass(
													"ui-state-active ui-corner-top").children(".ui-icon")
						...
						a.toHide.filter(":hidden").each(a.complete).end()
								.filter(":visible").animate(
										h,
										{
											step : function(j, i) {
												if (i.prop == "height")
													f = i.end - i.start === 0 ? 0 : (i.now - i.start)
															/ (i.end - i.start);
												a.toShow[0].style[i.prop] = f * g[i.prop].value
														+ g[i.prop].unit
											},
											duration : a.duration,
											easing : a.easing,
	...
	e.widget("ui.autocomplete", {
						...
						c.target === d
								&& setTimeout(function() {
									e(document).one(
											"mousedown",
											function(f) {
												f.target !== a.element[0] && f.target !== d
		...
		destroy : function() {
			this.element.removeClass("ui-autocomplete-input").removeAttr(
					"autocomplete").removeAttr("role").removeAttr("aria-autocomplete")
					...
					"ui.menu",
					{
						...
						refresh : function() {
							...
							this.element.children("li:not(.ui-menu-item):has(a)").addClass(
									"ui-menu-item").attr("role", "menuitem").children("a")
									.addClass("ui-corner-all").attr("tabindex", -1).mouseenter(
											function(b) {
...
(function(a) {
					...
					"ui.button",
					{
						...
						_determineButtonType : function() {
							...
							if (this.type === "checkbox" || this.type === "radio") {
								this.buttonElement = this.element.parents().last().find(
						...
						_resetButton : function() {
							if (this.type === "input")
								...
								var b = this.buttonElement
										...
										"<span></span>").addClass("ui-button-text").html(
										this.options.label).appendTo(b.empty()).text(), d = this.options.icons, e = d.primary
										&& d.secondary;
	...
	a.widget("ui.buttonset", {
		...
		refresh : function() {
			this.buttons = this.element.find(
					":button, :submit, :reset, :checkbox, :radio, a, :data(button)")
					.filter(":ui-button").button("refresh").end().not(":ui-button")
					.button().end().map(function() {
						return a(this).button("widget")[0]
					}).removeClass("ui-corner-all ui-corner-left ui-corner-right")
					.filter(":visible").filter(":first").addClass("ui-corner-left").end()
					.filter(":last").addClass("ui-corner-right").end().end().end()
		},
		destroy : function() {
...
(function(c, j) {
			...
			.widget(
					"ui.dialog",
					{
						...
						_create : function() {
							...
							var a = this, b = a.options, d = b.title || "&#160;", f = c.ui.dialog
									.getTitleId(a.element), g = (a.uiDialog = c("<div></div>"))
									.appendTo(document.body).hide().addClass(
							...
							a.element.show().removeAttr("title").addClass(
									"ui-dialog-content ui-widget-content").appendTo(g);
							var e = (a.uiDialogTitlebar = c("<div></div>"))
									.addClass(
											"ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix")
									.prependTo(g), h = c('<a href="#"></a>').addClass(
							...
							(a.uiDialogTitlebarCloseText = c("<span></span>")).addClass(
									"ui-icon ui-icon-closethick").text(b.closeText).appendTo(h);
						...
						open : function() {
							if (!this._isOpen) {
								...
								c(
										a.element.find(":tabbable").get().concat(
												d.find(".ui-dialog-buttonpane :tabbable").get().concat(
														d.get()))).eq(0).focus();
								a._isOpen = true;
								a._trigger("open");
								return a
						...
						_createButtons : function(a) {
							var b = this, d = false, f = c("<div></div>").addClass(
									"ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"), g = c(
									"<div></div>").addClass("ui-dialog-buttonset").appendTo(f);
						...
						_makeResizable : function(a) {
							...
							}).css("position", g).find(".ui-resizable-se").addClass(
						...
						_size : function() {
							...
							this.element.css(
									a.height === "auto" ? {
										...
										height : c.support.minHeight ? "auto" : Math.max(
												a.minHeight - b, 0)
									} : {
										minHeight : 0,
	...
	c.extend(c.ui.dialog.overlay, {
		...
		create : function(a) {
			...
			var b = (this.oldInstances.pop() || c("<div></div>").addClass(
		...
		destroy : function(a) {
			this.oldInstances.push(this.instances.splice(
					c.inArray(a, this.instances), 1)[0]);
					...
					d.ui.mouse,
					{
						...
						_create : function() {
							...
							d(".ui-slider-handle", this.element).length === 0
									&& d("<a href='#'></a>").appendTo(this.element).addClass(
											"ui-slider-handle");
							...
							this.handles
									.keydown(
											function(c) {
												var e = true, f = d(this)
														.data("index.ui-slider-handle"), h, g, i;
												if (!a.options.disabled) {
													switch (c.keyCode) {
						...
						_mouseCapture : function(a) {
							...
							b = f.offset();
							this._clickOffset = !d(a.target).parents().andSelf().is(
									".ui-slider-handle") ? {
								left : 0,
								top : 0
							} : {
					...
					"ui.tabs",
					{
						...
						_cleanup : function() {
							this.lis.filter(".ui-state-processing").removeClass(
									"ui-state-processing").find("span:data(label.tabs)").each(
									function() {
										var a = d(this);
						...
						_tabify : function(a) {
							...
							this.anchors
									.each(function(g, f) {
										...
										if (h.test(i))
											...
											f = d("#" + i);
											if (!f.length) {
												f = d(c.panelTemplate).attr("id", i).addClass(
							...
							this.anchors
									.bind(
											c.event + ".tabs",
											function() {
												var g = this, f = d(g).closest("li"), i = b.panels
						...
						add : function(a, e, b) {
							...
							e = d(h.tabTemplate.replace(/#\{href\}/g, a).replace(
									/#\{label\}/g, e));
							...
							var j = d("#" + a);
							j.length
									|| (j = d(h.panelTemplate).attr("id", a).data("destroy.tabs",
											true));
							j
							...
							this._trigger("add", null, this._ui(this.anchors[b],
									this.panels[b]));
							return this
						},
						remove : function(a) {
					...
					L.prototype,
					{
							...
							if (c == "button" || c == "both") {
								...
								b.trigger = d(this._get(b, "buttonImageOnly") ? d("<img/>")
										.addClass(this._triggerClass).attr({
											...
											alt : c,
											title : c
										}) : d('<button type="button"></button>').addClass(
										this._triggerClass).html(f == "" ? c : d("<img/>").attr({
									src : f,
									alt : c,
									title : c
								})));
								...
								b.trigger.click(function() {
									d.datepicker._datepickerShowing
											...
											._hideDatepicker() : d.datepicker._showDatepicker(a[0]);
									return false
								})
							}
						},
						_autoSize : function(a) {
							if (this._get(a, "autoSize") && !a.inline) {
								...
								if (c.match(/[DM]/)) {
									...
									b.setMonth(e(this._get(a, c.match(/MM/) ? "monthNames"
											: "monthNamesShort")));
									b.setDate(e(this._get(a, c.match(/DD/) ? "dayNames"
											: "dayNamesShort"))
											+ 20 - b.getDay())
								}
							...
							if (b.hasClass(this.markerClassName)) {
								...
								if (e == "input") {
									...
									b.removeClass(this.markerClassName).unbind("focus",
											this._showDatepicker).unbind("keydown", this._doKeyDown)
						...
						_enableDatepicker : function(a) {
							...
							if (b.hasClass(this.markerClassName)) {
								...
								if (e == "input") {
									...
									b.children("." + this._inlineClass).children().removeClass(
											"ui-state-disabled");
						...
						_disableDatepicker : function(a) {
							...
							if (b.hasClass(this.markerClassName)) {
								...
								if (e == "input") {
									...
									b.children("." + this._inlineClass).children().addClass(
											"ui-state-disabled");
								this._disabledInputs = d.map(this._disabledInputs, function(f) {
									return f == a ? null : f
								});
						...
						_optionDatepicker : function(a, b, c) {
							...
							if (arguments.length == 2 && typeof b == "string")
								return b == "defaults" ? d.extend({}, d.datepicker._defaults)
										: e ? b == "all" ? d.extend({}, e.settings) : this._get(e,
												b) : null;
							var f = b || {};
							if (typeof b == "string") {
								f = {};
						...
						_doKeyDown : function(a) {
							...
							if (d.datepicker._datepickerShowing)
								...
								case 13:
									...
									c[0] ? d.datepicker._selectDay(a.target, b.selectedMonth,
											b.selectedYear, c[0]) : d.datepicker._hideDatepicker();
									return false;
								case 27:
									d.datepicker._hideDatepicker();
									break;
								case 33:
									d.datepicker._adjustDate(a.target, a.ctrlKey ? -d.datepicker
											._get(b, "stepBigMonths") : -d.datepicker._get(b,
											"stepMonths"), "M");
									break;
								case 34:
									d.datepicker._adjustDate(a.target, a.ctrlKey ? +d.datepicker
								...
								case 37:
									...
									if (a.originalEvent.altKey)
										d.datepicker._adjustDate(a.target,
												a.ctrlKey ? -d.datepicker._get(b, "stepBigMonths")
														: -d.datepicker._get(b, "stepMonths"), "M");
									break;
								case 38:
									if (a.ctrlKey || a.metaKey)
						...
						_doKeyPress : function(a) {
							...
							if (d.datepicker._get(b, "constrainInput")) {
								b = d.datepicker._possibleChars(d.datepicker._get(b,
										"dateFormat"));
								var c = String.fromCharCode(a.charCode == G ? a.keyCode
										: a.charCode);
						...
						_doKeyUp : function(a) {
							...
							if (a.input.val() != a.lastVal)
								try {
									if (d.datepicker.parseDate(
											d.datepicker._get(a, "dateFormat"), a.input ? a.input
													.val() : null, d.datepicker._getFormatConfig(a))) {
						...
						_showDatepicker : function(a) {
							...
							if (!(d.datepicker._isDisabledDatepicker(a) || d.datepicker._lastInput == a)) {
								...
								b.dpDiv.css({
									position : d.datepicker._inDialog && d.blockUI ? "static"
											: e ? "fixed" : "absolute",
									display : "none",
									left : c.left + "px",
									top : c.top + "px"
									...
									.bind(
											...
											function() {
												if (!b._isDisabledDatepicker(a.inline ? a.dpDiv
														.parent()[0] : a.input[0])) {
													d(this).parents(".ui-datepicker-calendar").find("a")
											...
											}).end().find("." + this._dayOverClass + " a").trigger(
											"mouseover").end();
						...
						_checkOffset : function(a, b, c) {
							var e = a.dpDiv.outerWidth(), f = a.dpDiv.outerHeight(), h = a.input ? a.input
									.outerWidth()
							...
							b.left -= Math.min(b.left, b.left + e > g && g > e ? Math
									.abs(b.left + e - g) : 0);
							b.top -= Math.min(b.top, b.top + f > k && k > f ? Math.abs(f + i)
									: 0);
							return b
						},
						_findPos : function(a) {
						...
						_hideDatepicker : function(a) {
							...
							if (!(!b || a && b != d.data(a, "datepicker")))
								if (this._datepickerShowing) {
									...
									d.effects && d.effects[a] ? b.dpDiv.hide(a, d.datepicker
											._get(b, "showOptions"), c, e)
											: b.dpDiv[a == "slideDown" ? "slideUp"
													: a == "fadeIn" ? "fadeOut" : "hide"]
													(a ? c : null, e);
									a || e();
						...
						formatDate : function(a, b, c) {
							...
							var e = (c ? c.dayNamesShort : null)
									...
									|| this._defaults.dayNames, h = (c ? c.monthNamesShort : null)
								...
								for ( var j = 0; j < a.length; j++)
									if (u)
										...
										case "D":
											...
											break;
										case "o":
											l += g("o", (b.getTime() - (new Date(b.getFullYear(), 0,
													0)).getTime()) / 864E5, 3);
											break;
										case "m":
						...
						_getDefaultDate : function(a) {
							return this._restrictMinMax(a, this._determineDate(a, this._get(
									a, "defaultDate"), new Date))
						},
						_determineDate : function(a, b, c) {
							var e = function(h) {
								...
								var g = (h.toLowerCase().match(/^c/) ? d.datepicker._getDate(a)
										: null)
							...
							if (b = (b = b == null ? c : typeof b == "string" ? f(b)
						...
						_getDate : function(a) {
							return !a.currentYear || a.input && a.input.val() == "" ? null
						...
						_generateHTML : function(a) {
							...
							b = this._daylightSavingAdjust(new Date(b.getFullYear(), b
									.getMonth(), b.getDate()));
							var c = this._get(a, "isRTL"), e = this
									._get(a, "showButtonPanel"), f = this._get(a,
									"hideIfNoPrevNext"), h = this._get(a,
									"navigationAsDateFormat"), i = this._getNumberOfMonths(a), g = this
									._get(a, "showCurrentAtPos"), k = this._get(a, "stepMonths"), l = i[0] != 1
									|| i[1] != 1, u = this
									._daylightSavingAdjust(!a.currentDay ? new Date(9999, 9, 9)
											: new Date(a.currentYear, a.currentMonth, a.currentDay)), j = this
							...
							var s = this._get(a, "dayNamesMin"), z = this._get(a,
									"monthNames"), v = this._get(a, "monthNamesShort"), p = this
									._get(a, "beforeShowDay"), w = this
									._get(a, "showOtherMonths"), H = this._get(a,
									"selectOtherMonths");
							...
							for ( var M = this._getDefaultDate(a), I = "", C = 0; C < i[0]; C++) {
								for ( var N = "", D = 0; D < i[1]; D++) {
									...
									for ( var O = 0; O < A; O++) {
										...
										for (t = 0; t < 7; t++) {
											var F = p ? p.apply(a.input ? a.input[0] : null, [ q ])
													: [ true, "" ], B = q.getMonth() != g, K = B && !H
													|| !F[0] || j && q < j || o && q > o;
											P += '<td class="'
													...
													+ (q.getTime() == J.getTime() && g == a.selectedMonth
															&& a._keyEvent || M.getTime() == q.getTime()
															&& M.getTime() == J.getTime() ? " "
															+ this._dayOverClass : "")
						...
						_generateMonthYearHeader : function(a, b, c, e, f, h, i, g) {
							var k = this._get(a, "changeMonth"), l = this._get(a,
							...
							if (h || !l)
								...
								i = function(s) {
									s = s.match(/c[+-].*/) ? c + parseInt(s.substring(1), 10) : s
						...
						_adjustInstDate : function(a, b, c) {
							...
							b = Math.min(a.selectedDay, this._getDaysInMonth(e, f))
									+ (c == "D" ? b : 0);
							e = this._restrictMinMax(a, this._daylightSavingAdjust(new Date(
									e, f, b)));
	...
	d.fn.datepicker = function(a) {
		...
		return this.each(function() {
			typeof a == "string" ? d.datepicker["_" + a + "Datepicker"].apply(
					d.datepicker, [ this ].concat(b)) : d.datepicker._attachDatepicker(
					this, a)
		})
	};
	d.datepicker = new L;
		...
		|| function(f, j) {
			...
			f.each([ "backgroundColor", "borderBottomColor", "borderLeftColor",
					...
					function(c, a) {
						f.fx.step[a] = function(b) {
							...
							b.elem.style[a] = "rgb("
									+ Math.max(Math.min(parseInt(b.pos * (b.end[0] - b.start[0])
											+ b.start[0], 10), 255), 0)
									+ ","
									+ Math.max(Math.min(parseInt(b.pos * (b.end[1] - b.start[1])
											+ b.start[1], 10), 255), 0)
									+ ","
									+ Math.max(Math.min(parseInt(b.pos * (b.end[2] - b.start[2])
											+ b.start[2], 10), 255), 0) + ")"
						}
					});
			var m = {
				...
				toggleClass : function(c, a, b, d, e) {
					return typeof a == "boolean" || a === j ? b ? f.effects.animateClass
							.apply(this, [ a ? {
								...
								remove : c
							}, b, d, e ]) : this._toggleClass(c, a) : f.effects.animateClass
							.apply(this, [ {
								toggle : c
							}, a, b, d ])
				},
			...
			f.extend(f.easing, {
				...
				easeInElastic : function(c, a, b, d, e) {
					...
					return -(h * Math.pow(2, 10 * (a -= 1)) * Math.sin((a * e - c) * 2
							* Math.PI / g))
							+ b
				},
				...
				easeInOutElastic : function(c, a, b, d, e) {
					...
					return h * Math.pow(2, -10 * (a -= 1))
							* Math.sin((a * e - c) * 2 * Math.PI / g) * 0.5 + d + b
				},
				...
				easeOutBounce : function(c, a, b, d, e) {
					return (a /= e) < 1 / 2.75 ? d * 7.5625 * a * a + b
							: a < 2 / 2.75 ? d * (7.5625 * (a -= 1.5 / 2.75) * a + 0.75) + b
									: a < 2.5 / 2.75 ? d
											* (7.5625 * (a -= 2.25 / 2.75) * a + 0.9375) + b : d
											* (7.5625 * (a -= 2.625 / 2.75) * a + 0.984375) + b
				},
				easeInOutBounce : function(c, a, b, d, e) {
					if (a < e / 2)
						return f.easing.easeInBounce(c, a * 2, 0, d, e) * 0.5 + b;
					return f.easing.easeOutBounce(c, a * 2 - e, 0, d, e) * 0.5 + d * 0.5
							+ b
				}
			})
		}(jQuery);;/*
...
(function(j) {
	j.effects.explode = function(a) {
		return this
				.queue(function() {
					var c = a.options.pieces ? Math.round(Math.sqrt(a.options.pieces))
							: 3, d = a.options.pieces ? Math.round(Math
							.sqrt(a.options.pieces)) : 3;
					a.options.mode = a.options.mode == "toggle" ? j(this).is(":visible") ? "hide"
							: "show"
							: a.options.mode;
		...
		return this
				.queue(function() {
					...
					var e = c.effects.createWrapper(b).css({
						overflow : "hidden"
					}), f = d == "show" != h, l = f ? [ "width", "height" ] : [ "height",
							"width" ];
		...
		return this
				.queue(function() {
					var a = b(this), e = [ "backgroundImage", "backgroundColor",
							"opacity" ], d = b.effects.setMode(a, c.options.mode || "show"), f = {
		...
		return this
				.queue(function() {
					var a = c(this), e = c.effects.setMode(a, b.options.mode || "hide"), g = parseInt(
							b.options.percent, 10) || 150, h = g / 100, i = {
						height : a.height(),
						width : a.width()
					};
					c.extend(b.options, {
		...
		return this
				.queue(function() {
					var a = c(this), e = c.extend(true, {}, b.options), g = c.effects
							...
							|| (parseInt(b.options.percent, 10) == 0 ? 0 : g == "hide" ? 0
		...
		return this
				.queue(function() {
					var a = c(this), e = [ "position", "top", "left", "width", "height",
							...
							"paddingLeft", "paddingRight" ], p = c.effects.setMode(a,
					...
					if (m == "content" || m == "both") {
						...
						a.find("*[width]").each(
								function() {
									...
									if (d.from.y != d.to.y) {
										child.from = c.effects.setTransition(child, f, d.from.y,
												child.from);
										child.to = c.effects.setTransition(child, f, d.to.y,
												child.to)
									}
									if (d.from.x != d.to.x) {
										child.from = c.effects.setTransition(child, k, d.from.x,
												child.from);
