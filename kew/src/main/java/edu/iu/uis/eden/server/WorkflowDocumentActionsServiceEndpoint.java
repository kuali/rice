...
public class WorkflowDocumentActionsServiceEndpoint implements  WorkflowDocumentActions {
	...
	public void init(Object context) {
        ...
        this.documentActions = (WorkflowDocumentActions)SpringLoader.getInstance().getService(new QName(KEWServiceLocator.WORKFLOW_DOCUMENT_ACTIONS_SERVICE));
    }
	...
	public RouteHeaderVO appSpecificRouteDocument(UserIdVO userId, RouteHeaderVO routeHeader, String actionRequested, String nodeName, String annotation, ResponsiblePartyVO responsibleParty, String responsibilityDesc, boolean ignorePrevActions) throws RemoteException, WorkflowException {
		return documentActions.appSpecificRouteDocument(userId, routeHeader, actionRequested, nodeName, annotation, responsibleParty, responsibilityDesc, ignorePrevActions);
	}
