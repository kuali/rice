...
import org.kuali.rice.krad.web.struts.form.BlankFormFile;
...
//        GlobalVariables.getUserSession().addObject(DocumentAuthorizerBase.USER_SESSION_METHOD_TO_CALL_COMPLETE_OBJECT_KEY,Boolean.TRUE);
     ...
     *
     * @see org.kuali.rice.krad.web.struts.action.KualiAction#refresh(org.apache.struts.action.ActionMapping,
