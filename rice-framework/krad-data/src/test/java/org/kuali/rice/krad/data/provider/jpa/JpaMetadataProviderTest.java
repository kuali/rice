...
import org.kuali.rice.krad.data.provider.jpa.testbo.CollectionDataObject;
import org.kuali.rice.krad.data.provider.jpa.testbo.TestDataObject;
import org.kuali.rice.krad.data.provider.jpa.testbo.TestDataObjectTwoPkFields;
import org.kuali.rice.krad.data.provider.jpa.testbo.TestNonPersistableObject;
...
public class JpaMetadataProviderTest {
	...
	public void testGetMetadataForType() throws Exception {
		...
		metadata = metadataProvider.getMetadataForType(Class.forName("org.kuali.rice.krad.data.provider.jpa.testbo.TestDataObject"));
		Assert.assertNotNull("Returned metadata should not be null", metadata);
	}
...
.containsKey(Class.forName("org.kuali.rice.krad.data.provider.jpa.testbo.TestDataObject")));
	}
