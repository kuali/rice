...
public class RuleTemplateXmlParser implements XmlConstants {
    ...
    private RuleTemplate parseRuleTemplate(Element element, List<RuleTemplate> ruleTemplates) throws InvalidXmlException {
        ...
        if (!ruleTemplate.getRuleTemplateAttributes().isEmpty()) {
            ...
            for (RuleTemplateAttribute currentRuleTemplateAttribute: ruleTemplate.getRuleTemplateAttributes()) {
        ...
        if (attributesElement != null) {
            ...
            // and remove any ones that were omitted from the new definition
            ...
            List<RuleTemplateAttribute> attributes = parseRuleTemplateAttributes(attributesElement, ruleTemplate);
            for (RuleTemplateAttribute ruleTemplateAttribute: attributes) {
     ...
     * @param element the jdom Element object for the Rule Template
