 ...
 */
package org.kuali.rice.krad.sampleapp_2_4_M2.demo.travel.authorization;
...
import org.kuali.rice.krad.sampleapp_2_4_M2.demo.travel.authorization.dataobject.TravelerDetail;
...
public class TravelAuthorizationDocument extends TransactionalDocumentBase {
    ...
    // Traveler section
	@Column(name="TRAVELER_DTL_ID",length=40,precision=0)
