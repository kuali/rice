...
create table EN_USR_T (PRSN_EN_ID varchar(255) not null, PRSN_NTWRK_ID varchar(255), USR_CRTE_DT datetime, PRSN_NM varchar(255), PRSN_EMAIL_ADDR varchar(255), PRSN_UNIV_ID varchar(255), PRSN_GVN_NM varchar(255), PRSN_LST_NM varchar(255), USR_LST_UPDT_DT datetime, DB_LOCK_VER_NBR integer, PRSN_UNVL_USR_ID varchar(255), OBJ_ID varchar(255), VER_NBR bigint, primary key (PRSN_EN_ID)) ;
