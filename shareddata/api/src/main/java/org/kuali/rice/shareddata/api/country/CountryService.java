...
public interface CountryService {
    ...
    /**
     * Get a country object based on the given alternate country code. If the postal country code of the passed in
     * country is same as the passed in country code country code, return the existing country; otherwise, a new Country
     * is retrieved.
     *
    ...
    /**
     * Get a Country based on the given country code. If the postal country code of the passed in existing country is
     * the same as the passed in country code, the existing Country is returned;
     * otherwise a new Country is retrieved.
     *
     * @param postalCountryCode the given country code
