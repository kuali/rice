...
//		try {
//			EdenConstants.getDefaultDateFormat().parse(date.trim());
//			return true;
//		} catch (Exception ex) {
//			return false;
//		}
...
//            decodedPayload = KEWServiceLocator.getMessageHelper().deserializeObject(encodedPayload);
//        }
