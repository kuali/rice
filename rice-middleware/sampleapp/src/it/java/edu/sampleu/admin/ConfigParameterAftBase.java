 ...
 */
public abstract class ConfigParameterAftBase extends AdminTmplMthdAftNavBase {
    ...
    public void testConfigParameterNav(JiraAwareFailable failable) throws Exception {
        testEditCancel(); 
        navigate();
        testCreateNewCancel();
        passed();
