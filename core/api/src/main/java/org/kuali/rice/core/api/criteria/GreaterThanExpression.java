...
@XmlType(name = GreaterThanExpression.Constants.TYPE_NAME, propOrder = {
    CriteriaSupportUtils.PropertyConstants.VALUE,
    CoreConstants.CommonElements.FUTURE_ELEMENTS
})
public final class GreaterThanExpression extends AbstractExpression implements ValuedExpression {
    ...
    /**
	 * Constructs a GreaterThanExpression for the given path and value.  GreaterThanExpression supports the following {@link CriteriaValue}:
	 * 
	 * <ul>
	 ...
	 */
    GreaterThanExpression(String propertyPath, CriteriaValue<?> value) {
