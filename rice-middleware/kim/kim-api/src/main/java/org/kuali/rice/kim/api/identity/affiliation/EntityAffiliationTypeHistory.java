...
@XmlRootElement(name = EntityAffiliationTypeHistory.Constants.ROOT_ELEMENT_NAME)
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = EntityAffiliationTypeHistory.Constants.TYPE_NAME, propOrder = {
    EntityAffiliationTypeHistory.Elements.CODE,
    EntityAffiliationTypeHistory.Elements.NAME,
    EntityAffiliationTypeHistory.Elements.SORT_CODE,
    EntityAffiliationTypeHistory.Elements.ACTIVE,
    EntityAffiliationTypeHistory.Elements.EMPLOYMENT_AFFILIATION_TYPE,
    CoreConstants.CommonElements.VERSION_NUMBER,
    CoreConstants.CommonElements.OBJECT_ID,
    CoreConstants.CommonElements.FUTURE_ELEMENTS
})
public final class EntityAffiliationTypeHistory extends AbstractDataTransferObject
    implements EntityAffiliationTypeHistoryContract
{
     ...
     *
     */
    private EntityAffiliationTypeHistory() {
        this.name = null;
        this.code = null;
        this.sortCode = null;
    ...
    private EntityAffiliationTypeHistory(Builder builder) {
    ...
    /**
     * A builder which can be used to construct {@link org.kuali.rice.kim.api.identity.affiliation.EntityAffiliationTypeHistory} instances.  Enforces the constraints of the {@link org.kuali.rice.kim.api.identity.CodedAttributeContract}.
     * 
     */
    public final static class Builder
        implements Serializable, ModelBuilder, EntityAffiliationTypeHistoryContract
    {
        ...
        public static Builder create(EntityAffiliationTypeHistoryContract contract) {
            if (contract == null) {
        ...
        public EntityAffiliationTypeHistory build() {
            return new EntityAffiliationTypeHistory(this);
        }
