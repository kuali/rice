...
public class MaintenanceDocumentAuthorizerBase extends DocumentAuthorizerBase {
    ...
    public final boolean canCreate(Class<?> boClass, Person user) {
        ...
        permissionDetails.put(KimAttributes.DOCUMENT_TYPE_NAME, getMaintenanceDocumentDictionaryService()
                .getDocumentTypeName(boClass));
        permissionDetails.put(KNSConstants.MAINTENANCE_ACTN, KNSConstants.MAINTENANCE_NEW_ACTION);
        ...
        return !permissionExistsByTemplate(KNSConstants.KNS_NAMESPACE,
                ...
                || getIdentityManagementService().isAuthorizedByTemplateName(user.getPrincipalId(),
                        KNSConstants.KNS_NAMESPACE, KimConstants.PermissionTemplateNames.CREATE_MAINTAIN_RECORDS,
    ...
    public final boolean canMaintain(Object dataObject, Person user) {
        ...
        permissionDetails.put(KimAttributes.DOCUMENT_TYPE_NAME, getMaintenanceDocumentDictionaryService()
                .getDocumentTypeName(dataObject.getClass()));
        permissionDetails.put(KNSConstants.MAINTENANCE_ACTN, KNSConstants.MAINTENANCE_EDIT_ACTION);

        return !permissionExistsByTemplate(KNSConstants.KNS_NAMESPACE,
                KimConstants.PermissionTemplateNames.CREATE_MAINTAIN_RECORDS, permissionDetails)
                || isAuthorizedByTemplate(dataObject, KNSConstants.KNS_NAMESPACE,
    ...
    public final boolean canCreateOrMaintain(MaintenanceDocument maintenanceDocument, Person user) {
        return !permissionExistsByTemplate(maintenanceDocument, KNSConstants.KNS_NAMESPACE,
                KimConstants.PermissionTemplateNames.CREATE_MAINTAIN_RECORDS)
                || isAuthorizedByTemplate(maintenanceDocument, KNSConstants.KNS_NAMESPACE,
                        KimConstants.PermissionTemplateNames.CREATE_MAINTAIN_RECORDS, user.getPrincipalId());
    }
    ...
    protected void addRoleQualification(Object dataObject, Map<String, String> attributes) {
        ...
        if (dataObject instanceof MaintenanceDocument) {
            ...
            if (maintDoc.getNewMaintainableObject() != null) {
                attributes.putAll(KimCommonUtils.getNamespaceAndComponentSimpleName(maintDoc.getNewMaintainableObject()
                        .getBoClass()));
            }
        }
    }
    ...
    protected void addPermissionDetails(Object dataObject, Map<String, String> attributes) {
        ...
        if (dataObject instanceof MaintenanceDocument) {
            ...
            if (maintDoc.getNewMaintainableObject() != null) {
                attributes.putAll(KimCommonUtils.getNamespaceAndComponentSimpleName(maintDoc.getNewMaintainableObject()
                        .getBoClass()));
                attributes.put(KNSConstants.MAINTENANCE_ACTN, maintDoc.getNewMaintainableObject()
