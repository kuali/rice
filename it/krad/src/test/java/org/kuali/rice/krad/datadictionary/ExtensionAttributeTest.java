...
public class ExtensionAttributeTest extends KRADTestCase {
	...
	public void setUp() throws Exception {
		...
		dd.addConfigFileLocation("file:" + getUserDir() + "/impl/src/main/resources/org/kuali/rice/krad/uif/UifControlDefinitions.xml");
        dd.addConfigFileLocation("file:" + getUserDir() + "/impl/src/main/resources/org/kuali/rice/krad/uif/UifFieldDefinitions.xml");
		...
		dd.addConfigFileLocation("file:" + getUserDir() + "/impl/src/main/resources/org/kuali/rice/kim/bo/datadictionary/EmploymentType.xml");
		dd.addConfigFileLocation("file:" + getUserDir() + "/impl/src/main/resources/org/kuali/rice/kim/bo/datadictionary/PersonImpl.xml");
		dd.addConfigFileLocation("file:" + getUserDir() + "/impl/src/main/resources/org/kuali/rice/kim/bo/datadictionary/KimBaseBeans.xml");
        ...
        dd.addConfigFileLocation("file:" + getUserDir() + "/core/web/src/main/resources/org/kuali/rice/core/web/component/Component.xml");
