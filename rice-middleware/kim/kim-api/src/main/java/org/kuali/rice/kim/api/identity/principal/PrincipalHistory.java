...
@XmlRootElement(name = PrincipalHistory.Constants.ROOT_ELEMENT_NAME)
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = PrincipalHistory.Constants.TYPE_NAME, propOrder = {
    PrincipalHistory.Elements.PRINCIPAL_ID,
    PrincipalHistory.Elements.PRINCIPAL_NAME,
    PrincipalHistory.Elements.ENTITY_ID,
    PrincipalHistory.Elements.ACTIVE,
...
public final class PrincipalHistory extends AbstractDataTransferObject
    implements PrincipalHistoryContract
{
    ...
    private PrincipalHistory(Builder builder) {
    ...
    /**
     * A builder which can be used to construct {@link org.kuali.rice.kim.api.identity.principal.PrincipalHistory} instances.  Enforces the constraints of the {@link org.kuali.rice.kim.api.identity.principal.PrincipalContract}.
     *
     */
        ...
        implements Serializable, ModelBuilder, PrincipalHistoryContract
    {
        ...
        public static Builder create(PrincipalHistoryContract contract) {
            if (contract == null) {
        ...
        public PrincipalHistory build() {
            return new PrincipalHistory(this);
        }
    ...
    public static class Cache {
        public static final String NAME = KimConstants.Namespaces.KIM_NAMESPACE_2_0 + "/" + PrincipalHistory.Constants.TYPE_NAME;
    }
}