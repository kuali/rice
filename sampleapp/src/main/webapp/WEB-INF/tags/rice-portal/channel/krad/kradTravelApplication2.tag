...
<div class="body">
  ...
  <ul class="chan">
    ...
    <li><portal:portalLink displayTitle="true" title="Travel Authorization Transactional Document" url="${ConfigProperties.application.url}/kr-krad/approval?methodToCall=docHandler&command=initiate&dataObjectClassName=edu.sampleu.travel.approval.TravelAuthorizationDocument&viewName=TravelAuthorization"/></li>
  </ul>
