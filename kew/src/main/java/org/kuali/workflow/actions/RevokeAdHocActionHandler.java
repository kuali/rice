...
/**
 * Implements "revokeadhoc" action 
 * @author Kuali Rice Team (kuali-rice@googlegroups.com)
 */
public class RevokeAdHocActionHandler implements ActionHandler {
    /**
     ...
     * @param args AdHocRevoke adHocRevoke
     */
    public void invoke(DocumentRouteHeaderValue routeHeader, WorkflowUser user, String annotation, Object... args) throws InvalidActionTakenException, EdenUserNotFoundException {
        RevokeAdHocAction action = new RevokeAdHocAction(routeHeader, user, (AdHocRevoke) args[0], annotation);
