 ...
 */
public abstract class LocationCountyBlanketAppAftBase extends AdminTmplMthdAftNavBase {

    /**
     * ITUtil.PORTAL + "?channelTitle=County&channelUrl=" 
     * + WebDriverUtil.getBaseUrlString() + ITUtil.KNS_LOOKUP_METHOD + "org.kuali.rice.location.impl.county.CountyBo&docFormKey=88888888&returnLocation=" +
    ...
    public void testLocationCountyBlanketAppBookmark(JiraAwareFailable failable) throws Exception {
        testLocationCountyBlanketApprove();
        passed();
    }

    public void testLocationCountyBlanketAppNav(JiraAwareFailable failable) throws Exception {
        testLocationCountyBlanketApprove();
        passed();
    }
}
