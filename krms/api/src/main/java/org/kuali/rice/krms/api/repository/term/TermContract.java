 ...
 * @see TermSpecificationContract
 * @author Kuali Rice Team (rice.collab@kuali.org)
 */
public interface TermContract extends Identifiable, Versioned {

    /**
     * Get the associated {@link TermSpecificationContract} which specifies some important details about
     * the term.  Will not be null.
     *
     * @return the term specification
     */
    TermSpecificationContract getSpecification();

    /**
     * Get the description for this {@link TermContract}.  May be null.
     *
    ...
    /**
     * Get any parameters specified on this {@link TermContract}.  May be empty, but never null.
     *
     * @return the term's parameters
     */
    List<? extends TermParameterContract> getParameters();
