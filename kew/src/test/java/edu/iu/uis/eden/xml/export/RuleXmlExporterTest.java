...
public class RuleXmlExporterTest extends XmlExporterTestCase {
	...
	@Test public void testExport() throws Exception {
        ...
        loadXmlStream(new FileInputStream("conf/load_from_xml/RuleAttributeContent.xml"));
        loadXmlStream(new FileInputStream("conf/load_from_xml/RuleTemplateContent.xml"));
        loadXmlStream(new FileInputStream("conf/load_from_xml/DocumentTypeContent.xml"));
        loadXmlStream(new FileInputStream("conf/load_from_xml/RuleContent.xml"));
        assertExport();
    }
