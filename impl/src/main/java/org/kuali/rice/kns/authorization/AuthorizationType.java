...
public interface AuthorizationType {
    ...
    class Document extends AuthorizationTypeBase { // ability to interact in any way with a document (view/initiate/approve)
        private org.kuali.rice.kns.document.Document document;
        public Document(Class documentOrbusinessObjectClass, org.kuali.rice.kns.document.Document document) {
        ...
        public org.kuali.rice.kns.document.Document getDocument() {
            return document;
        }
    }
