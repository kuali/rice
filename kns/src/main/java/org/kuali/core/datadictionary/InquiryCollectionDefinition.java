...
public class InquiryCollectionDefinition extends FieldDefinition implements
	...
	private static Log LOG = LogFactory
			.getLog(InquiryCollectionDefinition.class);
	...
	public void addInquiryCollection(
		...
		if (LOG.isDebugEnabled()) {
			LOG.debug("calling addinquiryCollection for field '"
					+ inquiryCollection.getName() + "'");
		}
	...
	/**
	 * @return Collection of all lookupField MaintainableCollectionDefinitions
	 *         associated with this MaintainableCollectionDefinition, in the
	 *         order in which they were added
	 */
	public Collection<InquiryCollectionDefinition> getInquiryCollections() {
		return Collections.unmodifiableCollection(this.inquiryCollections
				.values());
	}
	...
	/**
	 * @return Collection of all SummaryFieldDefinitions associated with this
	 *         SummaryFieldDefinition, in the order in which they were added
	 */
