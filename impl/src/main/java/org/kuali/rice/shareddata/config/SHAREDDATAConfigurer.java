...
package org.kuali.rice.shareddata.config;
 ...
 */
public class SHAREDDATAConfigurer extends ModuleConfigurer {
	private static final String SHAREDDATA_KSB_SPRING_BEANS_PATH = "classpath:org/kuali/rice/shareddata/config/SHAREDDATAServiceBusSpringBeans.xml";
	...
	public List<String> getPrimarySpringFiles() {
		...
		if ( isExposeServicesOnBus() ) {
		    springFileLocations.add(SHAREDDATA_KSB_SPRING_BEANS_PATH);
		}
