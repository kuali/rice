		...
		for (MaintainableSectionDefinition sectionDefinition : entry.getMaintainableSections()) {
			...
			for (MaintainableItemDefinition itemDefinition : itemDefinitions) {
				if (itemDefinition instanceof MaintainableFieldDefinition) {
					...
					AttributeDefinition attributeDefinition = KNSServiceLocatorWeb.getDataDictionaryService().getAttributeDefinition(object.getClass().getName(), itemDefinitionName);
