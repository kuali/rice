...
public class KualiInquirableImpl extends ViewHelperServiceImpl implements Inquirable<BusinessObject> {
	...
	public HtmlData getInquiryUrl(BusinessObject businessObject, String attributeName, boolean forceInquiry) {
		...
		for (Iterator iter = keys.iterator(); iter.hasNext();) {
			...
			AttributeSecurity attributeSecurity = KNSServiceLocator.getDataDictionaryService().getAttributeSecurity(
	...
	/**
	 * Retrieves the {@link KualiConfigurationService}. In the event that
	 * instances of this class are not created as Spring beans, override this
	 * method to return an instance from the service locator.
	 * 
	 * @return
	 */
