...
/**
 * Default implementation of the {@link MessageExceptionHandler} which handles 
 * exceptions thrown from message processing.
 *
 * @author rkirkend
 */
public class DefaultMessageExceptionHandler implements MessageExceptionHandler {
	...
	protected void requeue(Throwable throwable, PersistedMessage message) {
	...
	protected void saveMessage(Throwable throwable, PersistedMessage message) {
	...
	public Integer getMaxRetryAttempts() {
		try {
			...
			LOG.error("Constant '" + RiceConstants.ROUTE_QUEUE_MAX_RETRY_ATTEMPTS_KEY + "' is not a number and is being " + "used as a default for exception messages.  " + DEFAULT_MAX_RETRIES
    ...
    protected Integer getGlobalMaxRetryAttempts() {
        ...
        try {
            ...
            LOG.error("Constant '" + RiceConstants.ROUTE_QUEUE_MAX_RETRY_ATTEMPTS_OVERRIDE_KEY + "' is not a number and is being " + "used as a default for exception messages.  " + DEFAULT_MAX_RETRIES
                    + " will be used as a retry limit until this number is fixed");
        }
        return null;
    }
