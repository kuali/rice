...
/**
 * 
 * This class provides Metadata about a specific BusinessObject. Depending on
 * the circumstance or type of BO it will retrieve the data it needs from either
