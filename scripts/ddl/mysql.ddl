...
create table EN_DLGN_RSP_T (DLGN_RULE_ID bigint not null, DLGN_RULE_BASE_VAL_ID bigint, DB_LOCK_VER_NBR integer, RULE_RSP_ID bigint, primary key (DLGN_RULE_ID)) ;
...
create table FP_DOC_GROUP_T (FDOC_GRP_CD varchar(255) not null, OBJ_ID varchar(255), VER_NBR bigint, FDOC_CLASS_CD varchar(255), FDOC_GRP_NM varchar(255), primary key (FDOC_GRP_CD)) ;
...
create table KIM_ENTITY_ATTRIBUTES_T (ID bigint not null, OBJ_ID varchar(255), VER_NBR bigint, ATTRIBUTE_NAME varchar(255), ATTRIBUTE_TYPE_ID bigint, ATTRIBUTE_VALUE varchar(255), ENTITY_ID bigint, SPONSOR_NAMESPACE_ID bigint, primary key (ID)) ;
...
create table KIM_GROUP_ATTRIBUTES_T (ID bigint not null, OBJ_ID varchar(255), VER_NBR bigint, ATTRIBUTE_NAME varchar(255), ATTRIBUTE_TYPE_ID bigint, ATTRIBUTE_VALUE varchar(255), GROUP_ID bigint, primary key (ID)) ;
