 ...
 * work together. It is up to the client implementer to choose how broadly or
 ...
 *
 */
public interface ContextContract extends Versioned, Identifiable, Inactivatable {
    ...
    /**
     * Returns the list of agendas {@link AgendaContract} contained in the context definition.
     ...
     */
    List<? extends AgendaContract> getAgendas();
