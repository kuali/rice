...
public class EntityEmail implements ModelObjectComplete, EntityEmailContract{
    ...
    /**
     * A builder which can be used to construct {@link EntityEmail} instances.  Enforces the constraints of the {@link org.kuali.rice.kim.api.entity.email.EntityEmailContract}.
     * 
     */
