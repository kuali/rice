 ...
 *    - name: docPrefix + counter
 *    - first name: docPrefix + counter
...
def createSubmitComponentWithPendingApproval(int counter){
    ...
    def PRINCIPAL_ID = docPrefix + userIndex
    def ENTITY_ID = "E_" + docPrefix + userIndex
    def AFFILIATION_ID = "A_" + docPrefix + userIndex
    def ENT_NAME_ID = "EN_" + docPrefix + userIndex
    def USER_NAME = docPrefix + userIndex
    ...
    sql = "UPDATE `ricedev24`.`krns_maint_doc_t`  SET VER_NBR=000000002, DOC_CNTNT='$crypt_content' WHERE DOC_HDR_ID='$DOC_HDR_ID_1'"
    outfile << sql + newline + ";" + newline

    sql = "UPDATE `ricedev24`.`krew_doc_hdr_t`  SET DOC_HDR_STAT_CD='R', RTE_LVL=000000000, STAT_MDFN_DT='2014-04-17 14:03:09', CRTE_DT='2014-04-17 14:01:20', RTE_STAT_MDFN_DT='2014-04-17 14:03:09', VER_NBR=000000005, RTE_PRNCPL_ID='admin' WHERE DOC_HDR_ID='$DOC_HDR_ID_1'"
    outfile << sql + newline + ";" + newline

    sql = "INSERT INTO `ricedev24`.`krew_actn_itm_s` SET id=$ACTN_ITM_1"
    outfile << sql + newline + ";" + newline

    sql = "INSERT INTO `ricedev24`.`krew_actn_itm_t` SET ACTN_ITM_ID='$ACTN_ITM_1', PRNCPL_ID='$user', ASND_DT='2014-04-17 14:03:14', RQST_CD='A', ACTN_RQST_ID='$ACTN_RQST_1', DOC_HDR_ID='$DOC_HDR_ID_1', DOC_HDR_TTL='New ComponentBo - $DESCRIPTION ', DOC_TYP_LBL='Component Maintenance Document', DOC_HDLR_URL='http://localhost:8080/kr-dev/kr/maintenance.do?methodToCall=docHandler', DOC_TYP_NM='ComponentMaintenanceDocument', RSP_ID='-1', VER_NBR=000000000"
    outfile << sql + newline + ";" + newline

    sql = "UPDATE `ricedev24`.`krew_rte_node_instn_t`  SET RTE_NODE_INSTN_ID='$RTE_NODE_ID_1', DOC_HDR_ID='$DOC_HDR_ID_1', RTE_NODE_ID='2917', BRCH_ID='$RTE_NODE_ID_2', ACTV_IND=000000001, CMPLT_IND=000000000, INIT_IND=000000000, VER_NBR=000000002 WHERE RTE_NODE_INSTN_ID='$RTE_NODE_ID_1'"
    outfile << sql + newline + ";" + newline

    sql = "UPDATE `ricedev24`.`krew_actn_rqst_t`  SET ACTN_RQST_ID='$ACTN_RQST_1', ACTN_RQST_CD='A', DOC_HDR_ID='$DOC_HDR_ID_1', STAT_CD='A', RSP_ID='-1', PRNCPL_ID='$user', RECIP_TYP_CD='U', PRIO_NBR=000000000, RTE_LVL_NBR=000000000, RTE_NODE_INSTN_ID='$RTE_NODE_ID_1', DOC_VER_NBR=000000001, CRTE_DT='2014-04-17 14:03:08', RSP_DESC_TXT='', FRC_ACTN=000000001, ACTN_RQST_ANNOTN_TXT='Ad Hoc Routed by admin', APPR_PLCY='F', CUR_IND=000000001, VER_NBR=000000000 WHERE ACTN_RQST_ID='$ACTN_RQST_1'"
