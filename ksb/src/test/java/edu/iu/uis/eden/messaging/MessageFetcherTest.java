...
public class MessageFetcherTest extends KSBTestCase {
	...
	assertEquals("Message Queue should have a single remaining message because only single message was resent", new Integer(1), KSBServiceLocator.getRouteQueueService().getNextDocuments(null).size());
    }
