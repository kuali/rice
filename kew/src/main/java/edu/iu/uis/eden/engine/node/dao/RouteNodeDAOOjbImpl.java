...
public class RouteNodeDAOOjbImpl extends PersistenceBrokerDaoSupport implements RouteNodeDAO {
    ...
    public List findProcessNodeInstances(RouteNodeInstance process) {
        ...
        return (List) getPersistenceBrokerTemplate().getCollectionByQuery(new QueryByCriteria(RouteNodeInstance.class, crit));
    }
    ...
    public void deleteNodeStateById(Long nodeStateId){
        ...
        NodeState nodeState=(NodeState)getPersistenceBrokerTemplate().getObjectByQuery(new QueryByCriteria(NodeState.class, criteria));
