...
/**
 * TODO: this needs to be rewritten to use resources in the krad it package, not the sampleapp
 * Inegration tests for proving correct operation of the ViewHelperService.
 *
...
public class ViewLifecycleTest extends KRADTestCase {
    ...
    //        modelAndView.addObject(UifConstants.DEFAULT_MODEL_NAME, loginForm);
    //
    ...
    //        assertEquals("Rice-UserName", ObjectPropertyUtils.getPropertyValue(dummyLogin,
