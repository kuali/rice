 ...
 */
public abstract class PersonPendingApprovalsAbstractSmokeTestBase extends AdminTmplMthdSTNavBase{
    ...
    public void testPersonPendingApprovalsBookmark(Failable failable) throws Exception {
        testPersonPendingApprovals();
        passed();
    }

    public void testPersonPendingApprovalsNav(Failable failable) throws Exception {
        gotoMenuLinkLocator();
        testPersonPendingApprovals();
        passed();
    }
