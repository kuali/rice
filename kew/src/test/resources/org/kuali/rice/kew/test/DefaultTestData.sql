...
;
INSERT INTO KRIM_TYP_T(KIM_TYP_ID, OBJ_ID, VER_NBR, NM, SRVC_NM, ACTV_IND, NMSPC_CD)
  VALUES('54', 'fc377d60-6520-102c-a045-001e378e0bb6', 1, 'Document Type (Responsibility)', 'documentTypeResponsibilityTypeService', 'Y', 'KR-WKFLW')
;
...
;
INSERT INTO KRIM_TYP_ATTR_T (KIM_TYP_ATTR_ID, OBJ_ID, VER_NBR, KIM_TYP_ID, KIM_ATTR_DEFN_ID, ACTV_IND, SORT_CD) VALUES('107', '37f0b7e0-6521-102c-a045-001e378e0bb6', 1, '54', '13', 'Y', 'a')
;
...
INSERT INTO KRIM_ROLE_T (ACTV_IND,KIM_TYP_ID,LAST_UPDT_DT,NMSPC_CD,OBJ_ID,ROLE_ID,ROLE_NM,VER_NBR)
  VALUES ('Y','2', {d '2005-12-31'},'KUALI','5ADF18B6D4847954E0404F8189D85002','1','User',1)
;
INSERT INTO KRIM_ROLE_T (ACTV_IND,KIM_TYP_ID,LAST_UPDT_DT,NMSPC_CD,OBJ_ID,ROLE_ID,ROLE_NM,VER_NBR)
  VALUES ('Y','45', {d '2008-11-14'},'KR-NS','5BABFACC4F61A8EEE0404F8189D8770F','66','Document Editor',1)
;
...
;
INSERT INTO KRIM_RSP_T(RSP_ID, OBJ_ID, RSP_TMPL_ID, nm, DESC_TXT, nmspc_cd, ACTV_IND) VALUES('14', '5B4F09743F4DEF33ED404F8189D44F25', '2', null, null, 'KR-SYS', 'Y')
;
