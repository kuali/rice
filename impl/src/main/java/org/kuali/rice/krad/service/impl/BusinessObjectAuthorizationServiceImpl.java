...
import org.kuali.rice.krad.authorization.BusinessObjectRestrictionsBase;
...
import org.kuali.rice.krad.authorization.InquiryOrMaintenanceDocumentRestrictions;
import org.kuali.rice.krad.authorization.InquiryOrMaintenanceDocumentRestrictionsBase;
...
import org.kuali.rice.krad.document.authorization.MaintenanceDocumentRestrictionsBase;
...
public class BusinessObjectAuthorizationServiceImpl implements
	...
	public boolean canCreate(Class<?> dataObjectClass, Person user, String docTypeName){
	    ...
	    boolean canCreate = ((MaintenanceDocumentPresentationController) documentPresentationController).canCreate(dataObjectClass);
	    if(canCreate){
...
//		}
	...
	/**
	 * @see org.kuali.rice.krad.service.BusinessObjectAuthorizationService#attributeValueNeedsToBeEncryptedOnFormsAndLinks(java.lang.Class, java.lang.String)
	 */
