 ...
 *  HashMap - BoundType
 */
public class CopyOfAdapterAttributeSetToHashMap extends XmlAdapter<AttributeSetList, HashMap<String, String>> {
    public CopyOfAdapterAttributeSetToHashMap() {
    }

    // Convert a value type to a bound type.
    // read xml content and put into Java class.
    public HashMap<String, String> unmarshal(AttributeSetList v) {
    ...
    public AttributeSetList marshal(HashMap<String, String> v) {
