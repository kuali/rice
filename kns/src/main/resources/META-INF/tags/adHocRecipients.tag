            ...
            <table cellpadding="0" cellspacing="0" class="datatable" summary="view/edit ad hoc recipients">
	          ...
	          <tr>
                ...
                <tr>
                    ...
                    <td class="infoline" ><div align=center>
                        <html:image property="methodToCall.insertAdHocRoutePerson" src="images/tinybutton-add1.gif" title="Insert Additional Ad Hoc Person" alt="Insert Additional Ad Hoc Person" styleClass="tinybutton"/></div>
                    </td>
                </tr>
	            <logic:iterate name="KualiForm" id="person" property="adHocRoutePersons" indexId="ctr">
	                <tr>
	                    ...
	                    <td class="datacell center" ><div align=center>
	                        ...
	                        <td class="datacell center" ><div align=center>
                            <html:image property="methodToCall.deleteAdHocRoutePerson.line${ctr}" src="images/tinybutton-delete1.gif" title="Delete Additional Ad Hoc Person" alt="Delete Additional Ad Hoc Person" styleClass="tinybutton"/></div>
	                    </td>
	                </tr>
	            </logic:iterate>
	          ...
	          <tr>
                ...
                <tr>
                    ...
                    <td class="infoline" ><div align=center>
                        <html:image property="methodToCall.insertAdHocRouteWorkgroup" src="images/tinybutton-add1.gif" title="Insert Additional Ad Hoc Workgroup" alt="Insert Additional Ad Hoc Workgroup" styleClass="tinybutton"/></div>
                    </td>
                </tr>
                <logic:iterate name="KualiForm" id="workgroup" property="adHocRouteWorkgroups" indexId="ctr">
                    <tr>
                        ...
                        <td class="datacell center" ><div align=center>
                            <html:image property="methodToCall.deleteAdHocRouteWorkgroup.line${ctr}" src="images/tinybutton-delete1.gif" title="Delete Additional Ad Hoc Workgroup" alt="Delete Additional Ad Hoc Workgroup" styleClass="tinybutton"/></div>
                        </td>
                    </tr>
                </logic:iterate>
	        </table>
