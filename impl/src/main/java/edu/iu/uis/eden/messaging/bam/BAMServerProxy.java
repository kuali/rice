...
public class BAMServerProxy extends BaseTargetedInvocationHandler {
	...
	public static Object wrap(Object target, ServiceInfo entry) {
		return Proxy.newProxyInstance(target.getClass().getClassLoader(), ContextClassLoaderProxy.getInterfacesToProxyIncludeSpring(target), new BAMServerProxy(target, entry));
	}
