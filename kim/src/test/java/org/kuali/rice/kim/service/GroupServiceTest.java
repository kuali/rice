...
@PerTestUnitTestData(
        @UnitTestData(
            sqlStatements = {
            		...
            		@UnitTestSql("INSERT INTO  KIM_ATTRIBUTES_TYPES_T (ID,NAME,DESCRIPTION) VALUES(1, 'TEST_ATTRIBUTE','TEST') "),            		                
            		...
            		@UnitTestSql("INSERT INTO  KIM_ENTITY_TYPES_T (ID,NAME,DESCRIPTION) VALUES(1, 'PRINCIPAL','PRINCIPAL ENTITY') "),
