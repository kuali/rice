...
<div class="body">
    ...
    <ul class="chan">
		...
		<li><portal:portalLink displayTitle="true" title="Proposal/Award Close" url="lookup.do?methodToCall=start&businessObjectClassName=org.kuali.module.cg.bo.ProposalClose&docFormKey=88888888&returnLocation=portal.do&hideReturnLink=true" /></li>
