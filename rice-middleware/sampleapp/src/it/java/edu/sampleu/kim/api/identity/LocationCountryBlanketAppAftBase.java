 ...
 */
public abstract class LocationCountryBlanketAppAftBase extends AdminTmplMthdAftNavBase {

    /**
     * ITUtil.PORTAL + "?channelTitle=Country&channelUrl=" 
     * + WebDriverUtil.getBaseUrlString() + ITUtil.KNS_LOOKUP_METHOD + "org.kuali.rice.location.impl.country.CountryBo&docFormKey=88888888&returnLocation=" +
    ...
    public void testLocationCountryBlanketAppBookmark(JiraAwareFailable failable) throws Exception {
        testLocationCountryBlanketApprove();
        passed();
    }

    public void testLocationCountryBlanketAppNav(JiraAwareFailable failable) throws Exception {
        testLocationCountryBlanketApprove();
        passed();
    }
}
