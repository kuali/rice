...
@BeanTags({@BeanTag(name = "group", parent = "Uif-GroupBase"),
        @BeanTag(name = "boxGroupBase", parent = "Uif-BoxGroupBase"),
        @BeanTag(name = "verticalBoxGroup", parent = "Uif-VerticalBoxGroup"),
        @BeanTag(name = "verticalBoxSection", parent = "Uif-VerticalBoxSection"),
        @BeanTag(name = "verticalBoxSubSection", parent = "Uif-VerticalBoxSubSection"),
        @BeanTag(name = "disclosure-verticalBoxSection", parent = "Uif-Disclosure-VerticalBoxSection"),
        @BeanTag(name = "disclosure-verticalBoxSubSection", parent = "Uif-Disclosure-VerticalBoxSubSection"),
        @BeanTag(name = "horizontalBoxGroup", parent = "Uif-HorizontalBoxGroup"),
        @BeanTag(name = "horizontalBoxSection", parent = "Uif-HorizontalBoxSection"),
        @BeanTag(name = "horizontalBoxSubSection", parent = "Uif-HorizontalBoxSubSection"),
        @BeanTag(name = "disclosure-horizontalBoxSection", parent = "Uif-Disclosure-HorizontalBoxSection"),
        @BeanTag(name = "disclosure-horizontalBoxSubSection", parent = "Uif-Disclosure-HorizontalBoxSubSection"),
        @BeanTag(name = "gridGroup", parent = "Uif-GridGroup"),
        @BeanTag(name = "gridSection", parent = "Uif-GridSection"),
        @BeanTag(name = "gridSubSection", parent = "Uif-GridSubSection"),
        @BeanTag(name = "disclosure-gridSection", parent = "Uif-Disclosure-GridSection"),
        @BeanTag(name = "disclosure-gridSubSection", parent = "Uif-Disclosure-GridSubSection"),
        ...
        @BeanTag(name = "actionsGroup", parent = "Uif-ActionsGroup"),
        @BeanTag(name = "disclosureActionsGroup", parent = "Uif-DisclosureActionsGroup"),
        @BeanTag(name = "disclosureActions-reqMessageGroup", parent = "Uif-DisclosureActions-ReqMessageGroup"),
        @BeanTag(name = "inactiveItemsActionsGroup", parent = "Uif-InactiveItemsActionsGroup"),
        @BeanTag(name = "documentInfoGroup", parent = "Uif-DocumentInfoGroup"),
        @BeanTag(name = "documentOverviewSection", parent = "Uif-DocumentOverviewSection"),
        @BeanTag(name = "documentAdHocRecipientsSection", parent = "Uif-DocumentAdHocRecipientsSection"),
        @BeanTag(name = "documentRouteLogSection", parent = "Uif-DocumentRouteLogSection"),
        @BeanTag(name = "documentPageFooter", parent = "Uif-DocumentPageFooter"),
        @BeanTag(name = "incidentDetailGroup", parent = "Uif-IncidentDetailGroup"),
        @BeanTag(name = "incidentStackTraceGroup", parent = "Uif-IncidentStackTraceGroup"),
        @BeanTag(name = "incidentReportFooter", parent = "Uif-IncidentReportFooter"),
        @BeanTag(name = "initiatedDocumentFooter", parent = "InitiatedDocumentFooter"),
        @BeanTag(name = "inquiryFooter", parent = "Uif-InquiryFooter"),
        @BeanTag(name = "lookupCriteriaGroup", parent = "Uif-LookupCriteriaGroup"),
        @BeanTag(name = "lookupPageHeaderGroup", parent = "Uif-LookupPageHeaderGroup"),
        @BeanTag(name = "lookupCriteriaFooter", parent = "Uif-LookupCriteriaFooter"),
        @BeanTag(name = "lookupResultsFooter", parent = "Uif-LookupResultsFooter"),
        @BeanTag(name = "maintenanceGridGroup", parent = "Uif-MaintenanceGridGroup"),
        @BeanTag(name = "maintenanceHorizontalBoxGroup", parent = "Uif-MaintenanceHorizontalBoxGroup"),
        @BeanTag(name = "maintenanceVerticalBoxGroup", parent = "Uif-MaintenanceVerticalBoxGroup"),
        ...
        @BeanTag(name = "maintenanceHorizontalBoxSection", parent = "Uif-MaintenanceHorizontalBoxSection"),
        @BeanTag(name = "maintenanceVerticalBoxSection", parent = "Uif-MaintenanceVerticalBoxSection"),
        @BeanTag(name = "maintenanceHorizontalBoxSubSection", parent = "Uif-MaintenanceHorizontalBoxSubSection"),
        @BeanTag(name = "maintenanceVerticalBoxSubSection", parent = "Uif-MaintenanceVerticalBoxSubSection")
})
