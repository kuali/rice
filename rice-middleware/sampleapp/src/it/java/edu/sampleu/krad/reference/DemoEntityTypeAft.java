 ...
 */
public class DemoEntityTypeAft extends WebDriverLegacyITBase {
    ...
    @Test
    public void testDemoEntityTypeBookmark() throws Exception {
        testDemoEntityType();
        passed();
    }

    @Test
    public void testDemoEntityTypeNav() throws Exception {
        testDemoEntityType();
        passed();
    }
}
