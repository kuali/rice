 ...
 * </pre>
 *
 * <p>The test.jar which is in the zip file has one resource in it which is named test-lib.txt.
 *
 * <p>The workflow.xml file has 2 params in it and includes the workflow2.xml file.
 *
 * @author Eric Westfall
 */
public class ZipFilePluginLoaderTest extends LoggableTestCase {
	...
	@Test public void testLoad() throws Exception {
		...
		ZipFilePluginLoader loader = new ZipFilePluginLoader(pluginZipFile, null, ClassLoaderUtils.getDefaultClassLoader(), Core.getRootConfig(), false);
		...
		// verify that the plugin was extracted, should be in a directory named the same as the local part of the QName
