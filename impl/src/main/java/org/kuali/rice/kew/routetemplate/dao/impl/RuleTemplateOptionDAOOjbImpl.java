...
public class RuleTemplateOptionDAOOjbImpl extends PersistenceBrokerDaoSupport implements RuleTemplateOptionDAO {
  ...
  /*
   * (non-Javadoc)
   * @see org.kuali.rice.kew.routetemplate.dao.RuleTemplateOptionDAO#delete(java.lang.Long)
   */
  ...
  /*
   * (non-Javadoc)
   * @see org.kuali.rice.kew.routetemplate.dao.RuleTemplateOptionDAO#findByRuleTemplateOptionId(java.lang.Long)
   */
