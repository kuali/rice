...
/
ALTER TABLE kr_kim_ent_type_t ADD CONSTRAINT kr_kim_ent_type_tc1 UNIQUE (ent_type_nm)
/

CREATE TABLE kr_kim_afltn_type_t
(
    afltn_type_cd       VARCHAR2(40),
    ...
    emp_afltn_type_ind  VARCHAR2(1) DEFAULT 'N',
    actv_ind            VARCHAR2(1) DEFAULT 'Y',
...
/
ALTER TABLE kr_kim_afltn_type_t ADD CONSTRAINT kr_kim_afltn_type_tc1 UNIQUE (afltn_type_nm)
/
...
/
ALTER TABLE kr_kim_afltn_type_t ADD CONSTRAINT kr_kim_ext_id_type_tc0 UNIQUE (obj_id)
/
ALTER TABLE kr_kim_afltn_type_t ADD CONSTRAINT kr_kim_ext_id_type_tc1 UNIQUE (ext_id_typ_nm)
/

CREATE TABLE kr_kim_ent_name_type_t
(
    ent_name_type_cd    VARCHAR2(40),
...
/
ALTER TABLE kr_kim_ent_name_type_t ADD CONSTRAINT kr_kim_ent_name_type_tc1 UNIQUE (ent_name_type_nm)
/

CREATE TABLE kr_kim_addr_type_t
(
    addr_type_cd        VARCHAR2(40),
...
/
ALTER TABLE kr_kim_addr_type_t ADD CONSTRAINT kr_kim_addr_type_tc1 UNIQUE (addr_type_nm)
/
...
/
ALTER TABLE kr_kim_phone_type_t ADD CONSTRAINT kr_kim_phone_type_tc0 UNIQUE (phone_type_nm)
/

CREATE TABLE kr_kim_email_type_t
(
    email_type_cd       VARCHAR2(40),
...
/
ALTER TABLE kr_kim_email_type_t ADD CONSTRAINT kr_kim_email_type_tc0 UNIQUE (email_type_nm)
/
...
(
    ...
    actv_ind            VARCHAR2(1) DEFAULT 'Y',
    CONSTRAINT kr_kim_emp_type_tp1 PRIMARY KEY ( phone_typ_cd )
)
/
ALTER TABLE kr_kim_emp_type_t ADD CONSTRAINT kr_kim_emp_type_tc0 UNIQUE (obj_id)
/
ALTER TABLE kr_kim_emp_type_t ADD CONSTRAINT kr_kim_emp_type_tc0 UNIQUE (phone_typ_nm)
/
...
/
ALTER TABLE kr_kim_emp_stat_t ADD CONSTRAINT kr_kim_emp_stat_tc0 UNIQUE (emp_stat_nm )
/
KR_KIM_CTZNSHP_STAT_T 
CREATE TABLE kr_kim_ctzshp_stat_t
(
    ctznshp_stat_cd     VARCHAR2(40),
    obj_id              VARCHAR2(36) CONSTRAINT kr_kim_ctzshp_stat_tn1 NOT NULL,
    ver_nbr             NUMBER(8,0) DEFAULT 1 CONSTRAINT kr_kim_ctzshp_stat_tn2 NOT NULL,
    ctznshp_stat_nm     VARCHAR2(40),
    actv_ind            VARCHAR2(1) DEFAULT 'Y',
    CONSTRAINT kr_kim_ctzshp_stat_tp1 PRIMARY KEY ( ctznshp_stat_cd )
)
/
ALTER TABLE kr_kim_ctzshp_stat_t ADD CONSTRAINT kr_kim_ctzshp_stat_tc0 UNIQUE (obj_id)
/
ALTER TABLE kr_kim_ctzshp_stat_t ADD CONSTRAINT kr_kim_ctzshp_stat_tc0 UNIQUE (ctznshp_stat_nm)
/
...
CREATE TABLE kr_kim_entity_ent_typ_t
(
...
(
    ...
    ext_id             VARCHAR2(100), 
    actv_ind           VARCHAR2(1) DEFAULT 'Y',
    CONSTRAINT kr_kim_entity_afltn_tp1 PRIMARY KEY ( entity_ext_id_id )
)
/
...
(
    entity_prncpl_id VARCHAR2(40) constraint kr_kim_entity_principal_tn1 NOT NULL,
    obj_id VARCHAR2(36) CONSTRAINT kr_kim_entity_principal_tn2 NOT NULL,
    ver_nbr NUMBER(8,0) DEFAULT 1 CONSTRAINT kr_kim_entity_principal_tn3 NOT NULL,
    entity_prncpl_nm VARCHAR2(100) CONSTRAINT kr_kim_entity_principal_tn4 NOT NULL,
    entity_id VARCHAR2(40),
    prncpl_pswd VARCHAR2(400),
    actv_ind VARCHAR2(1) DEFAULT 'Y',
    CONSTRAINT kr_kim_entity_principal_tp1 PRIMARY KEY ( entity_prncpl_id )
)
/
