...
<div class="body">
   ...
   <ul class="chan">
     ...
     <li><portal:portalLink displayTitle="true" title="Collections M2 items Test View" url="${ConfigProperties.application.url}/kr-krad/uicomponents?viewId=CollectionsM2Test_KNS&methodToCall=start" /></li>
   </ul>
