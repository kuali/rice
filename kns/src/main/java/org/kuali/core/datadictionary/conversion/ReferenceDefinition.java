...
public class ReferenceDefinition extends DataDictionaryDefinitionBase {
    ...
    private Class<BusinessObject> collectionBusinessObjectClass;
    ...
    public Class<BusinessObject> getCollectionBusinessObjectClass() {
        return collectionBusinessObjectClass;
    }

    public void setCollectionBusinessObjectClass(Class<BusinessObject> collectionBusinessObjectClass) {
