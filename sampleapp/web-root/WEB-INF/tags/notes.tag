...
<%-- NEED TO ADD THIS TOPIC FIELD TO DATABASE REMOVE THIS COMMENT ONCE FIELD IS THERE--%>
                ...
                <tr>
                    ...
                    <td class="infoline">
                        ...
                        <html:image property="methodToCall.cancelBOAttachment" src="images/tinygrey-cancel.gif" title="Cancel Attachment" alt="Cancel Attachment" styleClass="tinybutton"/>
                        </div>
                    </td>
                    <c:if test="${not empty attachmentTypesValuesFinderClass}">
                    ...
                    <td class="infoline"><div align="center"><html:image property="methodToCall.insertBONote" src="images/tinybutton-add1.gif" alt="Add a Note" title="Add a Note" styleClass="tinybutton"/></div></td>
                </tr>
...
<%-- won't work until I add attachment logic to action --%>
                            ...
                            <c:choose>
                                <c:when test="${(!empty note.attachment) && (note.attachment.complete)}">
                                  <td class="datacell center">
                                    ...
                                    <html:image property="methodToCall.downloadBOAttachment.attachment[${status.index}]" src="images/clip.gif" alt="download attachment" style="padding:5px" onclick="excludeSubmitRestriction=true"/>
                        ...
                        <td class="datacell center"><c:if test="${allowsNoteDelete}"><div align="center"><html:image property="methodToCall.deleteBONote.line${status.index}" src="images/tinybutton-delete1.gif" title="Delete a Note" alt="Delete a Note" styleClass="tinybutton"/></div></c:if> &nbsp;</td>
                    </tr>
	</c:forEach>
	            </tbody>
        </table>
