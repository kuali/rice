...
import org.kuali.rice.krad.web.struts.action.KualiMultipartRequestHandler;
...
import org.kuali.rice.krad.web.struts.pojo.PojoFormBase;
...
public class WebUtils {
	...
	public static boolean canFullyUnmaskField(String businessObjectClassName, String fieldName, KualiForm form) {
		...
		if (form instanceof KualiDocumentFormBase) {
			return KRADServiceLocatorWeb.getBusinessObjectAuthorizationService().canFullyUnmaskField(
	...
	public static boolean canPartiallyUnmaskField(String businessObjectClassName, String fieldName, KualiForm form) {
		...
		if (form instanceof KualiDocumentFormBase) {
			return KRADServiceLocatorWeb.getBusinessObjectAuthorizationService().canPartiallyUnmaskField(
					GlobalVariables.getUserSession().getPerson(), businessObjClass, fieldName,
					((KualiDocumentFormBase) form).getDocument());
		}
		else {
	...
	public static boolean containsSensitiveDataPatternMatch(String fieldValue) {
		...
		Collection<String> sensitiveDataPatterns = parameterService.getParameterValuesAsString(KRADConstants.KRAD_NAMESPACE,
				ParameterConstants.ALL_COMPONENT, KRADConstants.SystemGroupParameterNames.SENSITIVE_DATA_PATTERNS);
