...
public interface DocumentLookupCustomizationMediator {
     ...
     * @param parameters a map containing the parameters representing the submission of the lookup form
     *
     * @return a list of error messages generated by the validation, may an empty list in which case the calling code
     * may safely ignore the response and assume that the given parameters validated successfully
     */
