...
public final class EntityPhoneHistory extends AbstractDataTransferObject
        implements EntityPhoneHistoryContract
{
    ...
    private final CodedAttributeHistory phoneType;
    ...
    private EntityPhoneHistory(Builder builder) {
    ...
    @Override
    public CodedAttributeHistory getPhoneType() {
    ...
    public final static class Builder
            implements Serializable, ModelBuilder, EntityPhoneHistoryContract
    {

        private String id;
        private String entityId;
        private String entityTypeCode;
        private CodedAttributeHistory.Builder phoneType;
        ...
        public static Builder create(EntityPhoneHistoryContract contract) {
            if (contract == null) {
            ...
            if (contract.getPhoneType() != null) {
                builder.setPhoneType(CodedAttributeHistory.Builder.create(contract.getPhoneType()));
            }
        ...
        public EntityPhoneHistory build() {
            return new EntityPhoneHistory(this);
        }
        ...
        @Override
        public CodedAttributeHistory.Builder getPhoneType() {
            return this.phoneType;
        }
        ...
        public void setPhoneType(CodedAttributeHistory.Builder phoneType) {
