...
//        for (KimRoleImpl role : baseLookup) {
//        	for (RoleMemberImpl roleMember : role.getMembers()) {
//                sort(roleMember.getAttributes(), new KimAttributeDataComparator());
//        	}
//        }
...
//			fields.add(typeField);
//			returnRows.add(new Row(fields));
//			//- assigned group namespace 
//			List namespaceOptionValues = getNamespaceOptionValues();
//			fields = new ArrayList<Field>();
//			typeField = new Field();
//			typeField.setFieldLabel("Group Name Space");
//			typeField.setPropertyName("groupNameSpace");
//	        typeField.setFieldValidValues(namespaceOptionValues);
...
//			fields = new ArrayList<Field>();
//			typeField = new Field();
//			typeField.setFieldLabel("Group Name");
//			typeField.setPropertyName("groupName");
//			typeField.setFieldType(Field.TEXT);
//			typeField.setMaxLength(200);
//			typeField.setSize(20);
//			fields.add(typeField);
//			returnRows.add(new Row(fields));
//			//- assigned responsibility namespace 
//			fields = new ArrayList<Field>();
//			typeField = new Field();
//			typeField.setFieldLabel("Responsibility Name Space");
//			typeField.setPropertyName("responsibilityNameSpace");
//	        typeField.setFieldValidValues(namespaceOptionValues);
//	        typeField.setFieldType(Field.DROPDOWN);
//			fields.add(typeField);
//			returnRows.add(new Row(fields));
//			//- assigned responsibility name 
//			fields = new ArrayList<Field>();
//			typeField = new Field();
//			typeField.setFieldLabel("Responsibility Name");
//			typeField.setPropertyName("rspName");
//			typeField.setFieldType(Field.TEXT);
//			typeField.setMaxLength(200);
//			typeField.setSize(20);
//			fields.add(typeField);
//			returnRows.add(new Row(fields));
//			//- assigned permission namespace 
//			fields = new ArrayList<Field>();
//			typeField = new Field();
//			typeField.setFieldLabel("Permission Name Space");
//			typeField.setPropertyName("permissionNameSpace");
//	        typeField.setFieldValidValues(namespaceOptionValues);
//	        typeField.setFieldType(Field.DROPDOWN);
//			fields.add(typeField);
//			returnRows.add(new Row(fields));
...
//			fields = new ArrayList<Field>();
//			typeField = new Field();
//			typeField.setFieldLabel("Permission Name");
//			typeField.setPropertyName("permissionName");
//			typeField.setFieldType(Field.TEXT);
//			typeField.setMaxLength(200);
//			typeField.setSize(20);
//			fields.add(typeField);
