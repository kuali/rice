...
public class EntityNameTypeHistoryBo extends EntityNameTypeBo implements CodedAttributeHistoryBoContract {
    ...
    public static CodedAttributeHistory to(EntityNameTypeHistoryBo bo) {
        if (bo == null) {
            return null;
        }
    ...
    public static EntityNameTypeHistoryBo from(CodedAttributeHistory immutable) {
        return CodedAttributeHistoryBoUtil.from(EntityNameTypeHistoryBo.class, immutable);
    }

    public static EntityNameTypeHistoryBo from(CodedAttribute immutable,
            Timestamp fromDate,
            Timestamp toDate) {
        return CodedAttributeHistoryBoUtil.from(EntityNameTypeHistoryBo.class, immutable, fromDate, toDate);
    }
}
