 ...
 */
public class KRAMetaRuleExpression extends BSFRuleExpression {
    ...
    protected void declareBeans(BSFManager manager, Rule rule, RouteContext context) throws BSFException {
        ...
        // define our special kra meta rule helper class
        manager.declareBean("metarule", new MetaRuleHelper(rule, context), MetaRuleHelper.class);
    }

    /**
     * Helper class that is exposed to KRA meta rule groovy scripts
     */
    private static final class MetaRuleHelper {
        private Rule rule;
        ...
        private MetaRuleHelper(Rule rule, RouteContext context) {
    ...
    /**
     * Evaluates the builtin kra meta rule expression
     * @param expression the builtin kra meta rule expression
     * @param rule the rule
