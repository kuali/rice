...
public interface SearchableAttribute extends Serializable {
	...
	public static final List SEARCHABLE_ATTRIBUTE_BASE_CLASS_LIST = Arrays.asList(new Class[] { SearchableAttributeStringValue.class,SearchableAttributeFloatValue.class,SearchableAttributeLongValue.class,SearchableAttributeDateTimeValue.class });
    
	/**
	 * this gives the xml representation of the attribute; 
	 * returning a standard java xml object might be a better approach here
	 * 
	 * @return
	 */
	...
	/**
	 * this will return the loaded data objects for storage in workflow’s database 
	 * to be related to the document the attributes xml content was loaded with
	 * @return
	 */
