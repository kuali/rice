...
insert into krms_typ_t 
(typ_id, nm, nmspc_cd, srvc_nm, actv, ver_nbr)
values ('T3', 'SAY_HELLO_ACTION', 'KRMS_TEST', 'myHelloSpamService', 'Y', 1)
;
...
values ('P101', 'is campus bloomington', 'T2', 'S','R201',1)
;
...
values ('101A', 'P101', 'campusCode', 'T', 1, 1)
;

insert into krms_prop_parm_t 
(prop_parm_id, prop_id, parm_val, parm_typ_cd, seq_no, ver_nbr)
values ('101B', 'P101', '=', 'O', 1, 1)
;

insert into krms_prop_parm_t 
(prop_parm_id, prop_id, parm_val, parm_typ_cd, seq_no, ver_nbr)
values ('101C', 'P101', 'BL', 'C', 1, 1)
;
