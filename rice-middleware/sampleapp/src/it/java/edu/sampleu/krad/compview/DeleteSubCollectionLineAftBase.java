 ...
 */
public abstract class DeleteSubCollectionLineAftBase extends WebDriverLegacyITBase {
    ...
    /**
     * Nav tests start at {@link org.kuali.rice.testtools.selenium.AutomatedFunctionalTestUtils#PORTAL}.  Bookmark Tests should override and return {@link DeleteSubCollectionLineAftBase#BOOKMARK_URL}
     * {@inheritDoc}
     * @return
     */    
    @Override
