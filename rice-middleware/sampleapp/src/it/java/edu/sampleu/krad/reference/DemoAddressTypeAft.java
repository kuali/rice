 ...
 */
public class DemoAddressTypeAft extends WebDriverLegacyITBase {
     ...
     */
    public static final String BOOKMARK_URL = AutomatedFunctionalTestUtils.PORTAL + "?channelTitle=Address%20Type&channelUrl="
            + WebDriverUtils.getBaseUrlString() + AutomatedFunctionalTestUtils.KRAD_LOOKUP_METHOD +
            "org.kuali.rice.kim.impl.identity.address.EntityAddressTypeBo&renderReturnLink=true";
    ...
    protected void testDemoAddressType() throws Exception { 
    ...
    @Test
    public void testDemoAddressTypeBookmark() throws Exception {
        testDemoAddressType();
        passed();
    }

    @Test
    public void testDemoAddressTypeNav() throws Exception {
        testDemoAddressType();
        passed();
    }
}
