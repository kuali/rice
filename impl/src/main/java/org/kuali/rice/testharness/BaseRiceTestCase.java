...
import org.kuali.rice.testharness.lifecycles.PerTestDataLoaderLifecycle;
import org.kuali.rice.testharness.runners.RiceUnitTestClassRunner;
...
public abstract class BaseRiceTestCase extends Assert implements MethodAware {
	...
	/**
	 * @see org.kuali.rice.testharness.MethodAware#setTestMethod(java.lang.reflect.Method)
	 */
