...
CREATE TABLE TRVL_AUTH_DOC_T (
    TRVL_AUTH_DOC_ID        VARCHAR(19) NOT NULL,
...
CREATE TABLE TRVL_PD_EXP_T  (
    ...
    VER_NBR       DECIMAL(8,0) NOT NULL DEFAULT '1',
    TRVL_DEST_ID  VARCHAR(40) NOT NULL,
    TRVL_AUTH_DOC_ID       VARCHAR(14) NOT NULL,
    PD_DT         DATETIME NULL,
...
CREATE TABLE TRVL_EXP_ITM_T  (
    ...
    VER_NBR      DECIMAL(8,0) NOT NULL DEFAULT '1',
    TRVL_AUTH_DOC_ID      VARCHAR(14) NOT NULL,
    TRVL_CO_ID         VARCHAR(40) NOT NULL,
...
INSERT INTO TRVL_EXP_ITM_T (EXP_ITM_ID, OBJ_ID,VER_NBR,TRVL_AUTH_DOC_ID,TRVL_CO_ID,EXP_TYP_CD,EXP_AMT,EXP_DESC, EXP_DT, EXP_REIMB, EXP_TXBL)
VALUES (last_insert_id(), uuid(),1,10000,10000,'ME', 30.00, 'Family Related', NOW(), 'Y','Y')
/
