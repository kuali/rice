...
//})
//@Table(name = "KRIM_HIST_EMAIL_TYP_T")
public class EntityEmailTypeHistoryBo extends EntityEmailTypeBo implements CodedAttributeHistoryBoContract {
    private static final long serialVersionUID = 7546046609268383835L;

    @Id
    @GeneratedValue(generator = "KRIM_HIST_EMAIL_TYP_ID_S")
    @PortableSequenceGenerator(name = "KRIM_HIST_EMAIL_TYP_ID_S")
    @Column(name ="HIST_ID")
    ...
    public static CodedAttributeHistory to(EntityEmailTypeHistoryBo bo) {
        if (bo == null) {
            return null;
        }
    ...
    public static EntityEmailTypeHistoryBo from(CodedAttributeHistory immutable) {
        return CodedAttributeHistoryBoUtil.from(EntityEmailTypeHistoryBo.class, immutable);
    }

    public static EntityEmailTypeHistoryBo from(CodedAttribute immutable,
            Timestamp fromDate,
            Timestamp toDate) {
        return CodedAttributeHistoryBoUtil.from(EntityEmailTypeHistoryBo.class, immutable, fromDate, toDate);
    }
}
