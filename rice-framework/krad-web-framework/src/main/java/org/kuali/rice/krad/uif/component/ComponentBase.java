...
public abstract class ComponentBase extends UifDictionaryBeanBase implements Component {
    ...
    */
    ...
    protected ComponentBase copyProperties(Cloneable component) {
        ((ComponentBase)component).setAdditionalComponentsToRefresh(new ArrayList<String>(this.getAdditionalComponentsToRefresh()));
        ((ComponentBase)component).setAdditionalCssClasses(new ArrayList<String>(this.getAdditionalCssClasses()));
        ((ComponentBase)component).setAlign(this.align);
        ((ComponentBase)component).setCellCssClasses(new ArrayList<String>(this.getCellCssClasses()));
        ((ComponentBase)component).setCellStyle(this.cellStyle);
        ((ComponentBase)component).setCellWidth(this.cellWidth);
        ((ComponentBase)component).setColSpan(this.colSpan);
        ((ComponentBase)component).setConditionalRefresh(this.conditionalRefresh);
        ((ComponentBase)component).setCssClasses(new ArrayList<String>(this.getCssClasses()));
        ((ComponentBase)component).setDataAttributes(new HashMap<String, String>(this.getDataAttributes()));
        ((ComponentBase)component).setDisableSessionPersistence(this.disableSessionPersistence);
        ((ComponentBase)component).setDisclosedByAction(this.disclosedByAction);
        ((ComponentBase)component).setFinalizeMethodToCall(this.finalizeMethodToCall);
        ((ComponentBase)component).setForceSessionPersistence(this.forceSessionPersistence);
        ((ComponentBase)component).setHidden(this.hidden);
        ((ComponentBase)component).setMethodToCallOnRefresh(this.methodToCallOnRefresh);
        ((ComponentBase)component).setOnBlurScript(this.onBlurScript);
        ((ComponentBase)component).setOnChangeScript(this.onChangeScript);
        ((ComponentBase)component).setOnClickScript(this.onClickScript);
        ((ComponentBase)component).setOnCloseScript(this.onCloseScript);
        ((ComponentBase)component).setOnDblClickScript(this.onDblClickScript);
        ((ComponentBase)component).setOnDocumentReadyScript(this.onDocumentReadyScript);
        ((ComponentBase)component).setOnFocusScript(this.onFocusScript);
        ((ComponentBase)component).setOnKeyDownScript(this.onKeyDownScript);
        ((ComponentBase)component).setOnKeyPressScript(this.onKeyPressScript);
        ((ComponentBase)component).setOnKeyUpScript(this.onKeyUpScript);
        ((ComponentBase)component).setOnLoadScript(this.onLoadScript);
        ((ComponentBase)component).setOnMouseDownScript(this.onMouseDownScript);
        ((ComponentBase)component).setOnMouseMoveScript(this.onMouseMoveScript);
        ((ComponentBase)component).setOnMouseOutScript(this.onMouseOutScript);
        ((ComponentBase)component).setOnMouseOverScript(this.onMouseOverScript);
        ((ComponentBase)component).setOnMouseUpScript(this.onMouseUpScript);
        ((ComponentBase)component).setOnSubmitScript(this.onSubmitScript);
        ((ComponentBase)component).setOnUnloadScript(this.onUnloadScript);
        ((ComponentBase)component).setOrder(this.order);
        ((ComponentBase)component).setPostRenderContent(this.postRenderContent);
        ((ComponentBase)component).setPreRenderContent(this.preRenderContent);
        ((ComponentBase)component).setProgressiveRender(this.progressiveRender);
        ((ComponentBase)component).setProgressiveRenderViaAJAX(this.progressiveRenderViaAJAX);
        ((ComponentBase)component).setReadOnly(this.readOnly);
        ((ComponentBase)component).setRefreshedByAction(this.refreshedByAction);
        ((ComponentBase)component).setRefreshTimer(this.refreshTimer);
        ((ComponentBase)component).setRefreshWhenChangedPropertyNames(new ArrayList<String>(this.refreshWhenChangedPropertyNames));
        ((ComponentBase)component).setRender(this.render);
        ((ComponentBase)component).setRenderedHtmlOutput(this.renderedHtmlOutput);
        ((ComponentBase)component).setRequired(this.required);
        ((ComponentBase)component).setResetDataOnRefresh(this.resetDataOnRefresh);
        ((ComponentBase)component).setRowSpan(this.rowSpan);
        ((ComponentBase)component).setSelfRendered(this.selfRendered);
        ((ComponentBase)component).setSkipInTabOrder(this.skipInTabOrder);
        ((ComponentBase)component).setStyle(this.style);
        ((ComponentBase)component).setTemplate(this.template);
        ((ComponentBase)component).setTemplateName(this.templateName);
        ((ComponentBase)component).setTemplateOptions(new HashMap<String, String>(this.templateOptions));
        ((ComponentBase)component).setTemplateOptionsJSString(this.templateOptionsJSString);
        ((ComponentBase)component).setTitle(this.title);
        ((ComponentBase)component).setValign(this.valign);
        ((ComponentBase)component).setWidth(this.width);
        ...
        ((ComponentBase)component).setComponentModifiers(componentModifiers);
