...
public class WorkflowDocumentTest extends KEWTestCase {
    ...
    @Test public void testGetPreviousRouteNodeNames() throws Exception {
        ...
        assertEquals("First node name should be last node visited", "Template1", previousNodeNames[0]);
        assertEquals("Last node name should be the first visisted", "Initiated", previousNodeNames[1]);
