...
public class KualiTransactionalDocumentFormBase extends KualiDocumentFormBase {
    ...
    protected String discoverDocumentTypeName() {
        return ((DataDictionaryService) KNSServiceLocatorWeb.getDataDictionaryService()).getDataDictionary().getDocumentEntry(getDocument().getClass().getName()).getDocumentTypeName();
    }
	...
	protected TransactionalDocument instantiateTransactionalDocumentByDocumentTypeName( String documentTypeName ) {
    	Class<TransactionalDocument> transDocClass = KNSServiceLocatorWeb.getTransactionalDocumentDictionaryService().getDocumentClassByName(documentTypeName);
