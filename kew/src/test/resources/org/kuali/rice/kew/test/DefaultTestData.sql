insert into KREW_APP_CNST_T (APPL_CNST_NM, VAL, VER_NBR) values ('Feature.CheckRouteLogAuthentication.CheckFuture', 'true', 1)
;
insert into KREW_APP_CNST_T (APPL_CNST_NM, VAL, VER_NBR) values ('RouteQueue.maxRetryAttempts', '0', 1)
;
...
;
insert into KREW_APP_CNST_T (APPL_CNST_NM, VAL, VER_NBR) values ('DocumentSearch.IsDocumentPopup', 'true', 0)
;
