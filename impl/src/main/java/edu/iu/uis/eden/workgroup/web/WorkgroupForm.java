...
public class WorkgroupForm extends WorkflowRoutingForm {
	...
	return (existingWorkgroup == null || existingWorkgroup instanceof Routable) && workgroup instanceof Routable;
    }
    ...
    /**
         * This method grabs the ids and members off of the Workgroup and populates them on the form bean in a manner which
         * can easily be accessed by the JSP Expression Language
         */
