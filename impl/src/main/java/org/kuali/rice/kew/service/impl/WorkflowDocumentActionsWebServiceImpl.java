...
//      update notes database based on notes and notesToDelete arrays in routeHeaderVO
    ...
    public RouteHeaderDTO adHocRouteDocumentToPrincipal(String principalId, RouteHeaderDTO routeHeaderVO, String actionRequested, String nodeName, String annotation, String recipientPrincipalId, String responsibilityDesc, boolean ignorePrevActions) throws WorkflowException {
        DocumentRouteHeaderValue routeHeader = init(routeHeaderVO);
        incomingParamCheck(principalId, "principalId");
        ...
        LOG.debug("AdHoc Route [principalId=" + principalId + ", docId=" + routeHeaderVO.getRouteHeaderId() + ", actionRequest=" + actionRequested + ", nodeName=" + nodeName + ", recipientPrincipalId=" + recipientPrincipalId + ", ignorePrevious=" + ignorePrevActions + ", annotation="+annotation+"]");
        routeHeader = KEWServiceLocator.getWorkflowDocumentService().adHocRouteDocumentToPrincipal(principalId, routeHeader, actionRequested, nodeName, annotation, recipientPrincipalId, responsibilityDesc, new Boolean(ignorePrevActions));
        return DTOConverter.convertRouteHeader(routeHeader, principalId);
    }
    
    public RouteHeaderDTO adHocRouteDocumentToGroup(String principalId, RouteHeaderDTO routeHeaderVO, String actionRequested, String nodeName, String annotation, String recipientGroupId, String responsibilityDesc, boolean ignorePrevActions) throws WorkflowException {
        DocumentRouteHeaderValue routeHeader = init(routeHeaderVO);
        incomingParamCheck(principalId, "principalId");
        incomingParamCheck(actionRequested, "actionRequested");
        //incomingParamCheck(routeMethodName, "routeMethodName");
        ...
        routeHeader = KEWServiceLocator.getWorkflowDocumentService().adHocRouteDocumentToGroup(principalId, routeHeader, actionRequested, nodeName, annotation, recipientGroupId, responsibilityDesc, new Boolean(ignorePrevActions));
        return DTOConverter.convertRouteHeader(routeHeader, principalId);
    }
