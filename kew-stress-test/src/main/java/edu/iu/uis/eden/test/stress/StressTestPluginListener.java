...
public class StressTestPluginListener implements PluginListener {

	private ClassPathXmlApplicationContext context;
	
	public void pluginInitialized(Plugin plugin) {
		context = new ClassPathXmlApplicationContext("edu/iu/uis/eden/test/stress/StressTestPluginSpringBeans.xml");
