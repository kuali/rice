...
@XmlRootElement(name = EntityAddressHistory.Constants.ROOT_ELEMENT_NAME)
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = EntityAddressHistory.Constants.TYPE_NAME, propOrder = {
    EntityAddressHistory.Elements.ID,
    EntityAddressHistory.Elements.ENTITY_TYPE_CODE,
    EntityAddressHistory.Elements.ENTITY_ID,
    EntityAddressHistory.Elements.ADDRESS_TYPE,
    EntityAddressHistory.Elements.ATTENTION_LINE,
    EntityAddressHistory.Elements.LINE1,
    EntityAddressHistory.Elements.LINE2,
    EntityAddressHistory.Elements.LINE3,
    EntityAddressHistory.Elements.CITY,
    EntityAddressHistory.Elements.STATE_PROVINCE_CODE,
    EntityAddressHistory.Elements.POSTAL_CODE,
    EntityAddressHistory.Elements.COUNTRY_CODE,
    EntityAddressHistory.Elements.ATTENTION_LINE_UNMASKED,
    EntityAddressHistory.Elements.LINE1_UNMASKED,
    EntityAddressHistory.Elements.LINE2_UNMASKED,
    EntityAddressHistory.Elements.LINE3_UNMASKED,
    EntityAddressHistory.Elements.CITY_UNMASKED,
    EntityAddressHistory.Elements.STATE_PROVINCE_CODE_UNMASKED,
    EntityAddressHistory.Elements.POSTAL_CODE_UNMASKED,
    EntityAddressHistory.Elements.COUNTRY_CODE_UNMASKED,
    EntityAddressHistory.Elements.ADDRESS_FORMAT,
    EntityAddressHistory.Elements.MODIFIED_DATE,
    EntityAddressHistory.Elements.VALIDATED_DATE,
    EntityAddressHistory.Elements.VALIDATED,
    EntityAddressHistory.Elements.NOTE_MESSAGE,
    EntityAddressHistory.Elements.SUPPRESS_ADDRESS,
    EntityAddressHistory.Elements.DEFAULT_VALUE,
    EntityAddressHistory.Elements.ACTIVE,
...
public final class EntityAddressHistory extends AbstractDataTransferObject
    implements EntityAddressHistoryContract
{
    ...
    private final CodedAttributeHistory addressType;
    ...
    private EntityAddressHistory(Builder builder) {
    ...
    @Override
    public CodedAttributeHistory getAddressType() {
    ...
    /* -------------------------------- */
    /**
     * A builder which can be used to construct {@link org.kuali.rice.kim.api.identity.address.EntityAddressHistory} instances.  Enforces the constraints of the {@link org.kuali.rice.kim.api.identity.address.EntityAddressContract}.
     * 
     */
    public final static class Builder
        implements Serializable, ModelBuilder, EntityAddressHistoryContract
    {

        private String entityId;
        private String entityTypeCode;
        private CodedAttributeHistory.Builder addressType;
        ...
        public static Builder create(EntityAddressHistoryContract contract) {
            if (contract == null) {
            ...
            if (contract.getAddressType() != null) {
                builder.setAddressType(CodedAttributeHistory.Builder.create(contract.getAddressType()));
            }
        ...
        public EntityAddressHistory build() {
            return new EntityAddressHistory(this);
        }
        ...
        @Override
        public CodedAttributeHistory.Builder getAddressType() {
            return this.addressType;
        }
        ...
        public void setAddressType(CodedAttributeHistory.Builder addressType) {
