 ...
 */
package org.kuali.rice.kns_2_4_M2.datadictionary.validation;
...
import org.kuali.rice.kns_2_4_M2.datadictionary.MaintainableFieldDefinition;
import org.kuali.rice.kns_2_4_M2.datadictionary.MaintainableItemDefinition;
import org.kuali.rice.kns_2_4_M2.datadictionary.MaintainableSectionDefinition;
import org.kuali.rice.kns_2_4_M2.datadictionary.MaintenanceDocumentEntry;
			        ...
			        if (isAttributeDefined) {
						...
						try {
							...
							if (attributeValue != null && StringUtils.isNotBlank(attributeValue.toString())) {
				    			Class<?> propertyType = ObjectPropertyUtils.getPropertyType(object, itemDefinitionName);
