...
VALUES (10000, sys_guid(), 1,'ME', 30, 'Family Related', SYSDATE, 'Y','Y')
/
...
VALUES (10000, 'IS', sys_guid(), 1, 'Colorado', 'US', 'CO', 'Y')
/
...
INSERT INTO TRVL_PD_EXP_T (PD_EXP_ID, OBJ_ID, VER_NBR, TRVL_DEST_ID, PD_DT, BKFST_VAL, LNCH_VAL, DNNR_VAL, INCD_VAL, MLG_RT_ID, MLG_EST)
VALUES (10000, sys_guid(), 1, 10000, SYSDATE, 10.00, 10.00, 15.00, 20.00, 10000, 30)
/
