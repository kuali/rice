...
@XmlRootElement(name = PermissionAttribute.Constants.ROOT_ELEMENT_NAME)
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = PermissionAttribute.Constants.TYPE_NAME, propOrder = {
        PermissionAttribute.Elements.ID,
        PermissionAttribute.Elements.PERMISSION_ID,
        PermissionAttribute.Elements.KIM_TYPE,
        PermissionAttribute.Elements.KIM_ATTRIBUTE,
        PermissionAttribute.Elements.ATTRIBUTE_VALUE,
        CoreConstants.CommonElements.VERSION_NUMBER,
        CoreConstants.CommonElements.OBJECT_ID,
        CoreConstants.CommonElements.FUTURE_ELEMENTS
})
public class PermissionAttribute implements PermissionAttributeContract, ModelObjectComplete {
    @XmlElement(name = Elements.ID, required = false)
    private final String id;

    @XmlElement(name = Elements.PERMISSION_ID, required = false)
	 ...
	 * @param builder
	 */
    public PermissionAttribute(Builder builder) {
    ...
    /**
     * This builder constructs a PermissionAttribute enforcing the constraints of the {@link PermissionAttributeContract}.
     */
    public static final class Builder implements PermissionAttributeContract, ModelBuilder, Serializable {
        private String id;
         ...
         */
        public static Builder create(PermissionAttributeContract contract) {
            Builder builder = new Builder(KimType.Builder.create(contract.getKimType()));
            builder.setId(contract.getId());
            builder.setPermissionId(contract.getPermissionId());            
        ...
        @Override
        public PermissionAttribute build() {
            return new PermissionAttribute(this);
        }
    }
    ...
    static class Constants {
        final static String ROOT_ELEMENT_NAME = "permissionAttribute";
        final static String TYPE_NAME = "PermissionAttributeType";
