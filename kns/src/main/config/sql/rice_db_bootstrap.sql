...
/
CREATE SEQUENCE SEQ_KOM_ORGANIZATION_ID INCREMENT BY 1 START WITH 1000
/
...
/
CREATE TABLE KOM_ORGANIZATION_CATEGORY_T (
		ID NUMBER(8) NOT NULL,
		NAME VARCHAR(255) NOT NULL,
		OBJ_ID VARCHAR2(36) DEFAULT SYS_GUID() NOT NULL, 
        VER_NBR NUMBER(8) DEFAULT 1 NOT NULL, 
		CONSTRAINT KOM_ORGANIZATION_CATEGORY_PK PRIMARY KEY (ID)
)
/
