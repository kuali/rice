...
CREATE TABLE TRVL_AUTH_DOC_T (
    TRVL_AUTH_DOC_ID VARCHAR2(19) NOT NULL,
    ...
    CONSTRAINT TRVL_AUTH_TC0 UNIQUE (OBJ_ID),
    CONSTRAINT TRVL_AUTH_FK1 FOREIGN KEY ( TRVL_DEST_ID )
...
VALUES('10000','1','IS',STR_TO_DATE( '20131201000000', '%Y%m%d%H%i%s' ),STR_TO_DATE( '20131205000000', '%Y%m%d%H%i%s' ),'10000',
...
INSERT INTO TRVL_EXP_ITM_T (EXP_ITM_ID, OBJ_ID,VER_NBR,TRVL_AUTH_DOC_ID,EXP_TYP_CD,EXP_AMT,EXP_DESC, EXP_DT, EXP_REIMB, EXP_TXBL)
VALUES (10000, sys_guid(), 1, 10000,'ME', 30, 'Family Related', SYSDATE, 'Y','Y')
/
