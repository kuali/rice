    	...
    	<table cellpadding=0 class="datatable" summary="Pre-Paid Travel Section">
           ...
           <table cellpadding=0 class="datatable" summary="Expenses">
            ...
            <tr>
              ...
              <c:if test="${fullEntryMode||travelEntryMode}">
	              <td class="infoline"><div align=center>
	                   <html:image src="images/tinybutton-add1.gif" styleClass="tinybutton" property="methodToCall.addPreConfRegistrantLine"  title="Add Pre-Conference Registrant Line" alt="Add Pre-Conference Registrant Line"/>
	              </div></td>
              </c:if>
            </tr>
            ...
            <tr>
              ...
              <c:if test="${fullEntryMode||travelEntryMode}">
	              <td><div align=center>
	                   <html:image src="images/tinybutton-delete1.gif" styleClass="tinybutton" property="methodToCall.deletePreConfRegistrantLine.line${ctr}" title="Delete Pre-Conference Registrant Line" alt="Delete Pre-Conference Registrant Line"/>
	              </div></td>
              </c:if>
            </tr>
            </logic:iterate>
