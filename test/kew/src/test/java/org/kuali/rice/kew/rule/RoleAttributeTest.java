...
public class RoleAttributeTest extends KEWTestCase {
	...
	@Test public void testWorkgroupRoleAttribute() throws Exception {
		...
		WorkflowDocument document = new WorkflowDocument(getPrincipalNameForId("user1"), "WorkgroupRoleAttributeDocument");
	...
	@Test public void testBadWorkgroupRoleAttribute() throws Exception {
		...
		WorkflowDocument document = new WorkflowDocument(getPrincipalNameForId("user1"), "BadWorkgroupRoleAttributeDocument");
