...
public class ClientSideStateViewSmokeTest extends SmokeTestBase{
    ...
    /**
     * /kr-krad/labs?viewId=Lab-ClientSideState&formKey=ff000d97-13e9-4130-81a3-bc0217e8e0eb&cacheKey=otutyty24mo0f76n59ebqxvtpg&pageId=Lab-ClientSideState-Page1  
     */
    ...
    public void testClientSideStateView() throws Exception
    {
        ...
        waitAndClickByXpath("//div[4]/div[2]/button");
        Thread.sleep(5000);
        ...
        waitAndClickByXpath("//div[4]/div[2]/button[2]");
        Thread.sleep(5000);
        Assert.assertFalse(isElementPresentByName(ACTIVE_COMPONENT_NAME));
        Assert.assertFalse(isElementPresentByName(ACTIVE_COMPONENT2_NAME));
    }
