...
/
CREATE TABLE ATTRIBUTE_TYPES_T (
        ID NUMBER(8) NOT NULL,
        NAME VARCHAR2(500) NOT NULL,
        DESCRIPTION VARCHAR2(4000),
		OBJ_ID VARCHAR2(36) DEFAULT SYS_GUID() NOT NULL, 
...
/
CREATE TABLE GROUP_ATTRIBUTES_T (
        ID NUMBER(8) NOT NULL,
...
/
CREATE TABLE PERSON_ATTRIBUTES_T (
        ID NUMBER(8) NOT NULL,
        PERSON_ID NUMBER(8) NOT NULL,
		...
		OBJ_ID VARCHAR2(36) DEFAULT SYS_GUID() NOT NULL, 
        VER_NBR NUMBER(8) DEFAULT 1 NOT NULL, 
        CONSTRAINT PERSON_ATTRIBUTES_PK PRIMARY KEY (ID)
)
/
...
/
CREATE TABLE ROLE_ATTRIBUTES_T (
        ID NUMBER(8) NOT NULL,
...
/
CREATE TABLE ROLES_PERMISSIONS_T (
        ROLE_ID NUMBER(8) NOT NULL,
...
/
ALTER TABLE GROUP_ATTRIBUTES_T
