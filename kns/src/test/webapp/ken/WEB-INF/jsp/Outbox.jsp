...
<html>
<head>
<title>Kuali Enterprise Notification - Outbox</title>
...
<%@ include file="WorkAreaTop.jsp" %>
               	...
               	<iframe name="iframe_51148" id="iframe_51148" src="../en/ActionList.do?viewOutbox=true" frameborder="0" scrolling="auto" width="100%" height="100%">
               	</iframe>
