...
public abstract class JstlPropertyHolder implements Map {
    ...
    /**
     * @see org.kuali.core.util.properties.PropertyTree#size()
     */
    public int size() {
        if (propertyTree == null) {
            throw new IllegalStateException("propertyTree has not been initialized");
    ...
    /**
     * @see org.kuali.core.util.properties.PropertyTree#containsValue(java.lang.Object)
     */
    ...
    /**
     * @see org.kuali.core.util.properties.PropertyTree#values()
     */
    ...
    /**
     * @see org.kuali.core.util.properties.PropertyTree#entrySet()
     */
    public Set entrySet() {
        if (propertyTree == null) {
            throw new IllegalStateException("propertyTree has not been initialized");
    ...
    /**
     * @see org.kuali.core.util.properties.PropertyTree#keySet()
     */
    public Set keySet() {
        if (propertyTree == null) {
            throw new IllegalStateException("propertyTree has not been initialized");
