...
public final class KimPermission implements KimPermissionContract, ModelObjectComplete{
    ...
    @XmlElement(name = KimPermission.Elements.ID, required = false)
    private final String id;

    @XmlElement(name = KimPermission.Elements.NAMESPACE_CODE, required = false)
    private final String namespaceCode;

    @XmlElement(name = KimPermission.Elements.NAME, required = false)
    ...
    /**
     * This builder constructs an KimPermission enforcing the constraints of the {@link KimPermissionContract}.
     */
