...
/**
 * An XML adapter that converts between PermissionDetailList objects and AttributeSet objects.
 ...
 */
public class PermissionDetailListAdapter extends XmlAdapter<PermissionDetailList,AttributeSet> {

    /**
     * @see javax.xml.bind.annotation.adapters.XmlAdapter#unmarshal(java.lang.Object)
     */
    @Override
    public AttributeSet unmarshal(PermissionDetailList v) throws Exception {
        if (v != null) {
     ...
     */
    @Override
    public PermissionDetailList marshal(AttributeSet v) throws Exception {
