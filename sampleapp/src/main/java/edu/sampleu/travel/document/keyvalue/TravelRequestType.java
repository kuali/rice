...
public class TravelRequestType extends KeyValuesBase {
    ...
    public List getKeyValues() {
        ...
        keyValues.add(new ContreteKeyValue("TRT1", "Travel Request Type 1"));
        keyValues.add(new ContreteKeyValue("TRT2", "Travel Request Type 2"));
    	...
    	if ((form != null) && (form instanceof KualiDocumentFormBase)) {
    	    ...
    	    if (doc != null) {
    	        keyValues.add(new ContreteKeyValue("TRT3", "Travel Request Type 3"));
    	    }
    	}
