	  ...
	  <table cellpadding=0 class="datatable" summary="Non-Employee Travel Section">
        ...
        <table cellpadding=0 class="datatable" summary="Destination">
            ...
            <tr>
              ...
              <img src="images/cal.gif" id="document.dvNonEmployeeTravel.perDiemStartDateTime_datepicker" style="cursor: pointer;" title="Date selector" alt="Date selector" onmouseover="this.style.backgroundColor='red';" onmouseout="this.style.backgroundColor='transparent';"	/>
            ...
            <tr>
              ...
              <c:if test="${fullEntryMode||travelEntryMode}">
              <img src="images/cal.gif" id="document.dvNonEmployeeTravel.perDiemEndDateTime_datepicker" style="cursor: pointer;" title="Date selector" alt="Date selector" onmouseover="this.style.backgroundColor='red';" onmouseout="this.style.backgroundColor='transparent';"	/>
                <script type="text/javascript">
                  Calendar.setup(
                          {
          ...
          <table cellpadding=0 class="datatable" summary="Per Diem, Personal Vehicle ">
            ...
            <tr>
              ...
              <c:if test="${fullEntryMode||travelEntryMode}">
                   <div class="right"><html:image src="images/tinybutton-clear1.gif" styleClass="tinybutton" property="methodToCall.clearTravelPerDiem" alt="Clear Per Diem" title="Clear Per Diem"/></div>
                   <div class="right"><html:image src="images/tinybutton-calculate.gif" styleClass="tinybutton" property="methodToCall.calculateTravelPerDiem" alt="Calculate Per Diem" title="Calculate Per Diem"/></div>
              </c:if>
              </td>
            ...
            <tr>
              ...
              <c:if test="${fullEntryMode||travelEntryMode}">
                   <div class="right"><html:image src="images/tinybutton-clear1.gif" styleClass="tinybutton" property="methodToCall.clearTravelMileageAmount" alt="Clear Total Mileage" title="Clear Total Mileage"/></div>
                   <div class="right"><html:image src="images/tinybutton-calculate.gif" styleClass="tinybutton" property="methodToCall.calculateTravelMileageAmount" alt="Calculate Total Mileage" title="Calculate Total Mileage"/></div>
              </c:if>
              </td>
            </tr>
           ...
           <tr>
            ...
            <tr>
              ...
              <td valign=top nowrap class="infoline"><div align="center">
	              ...
	              <td class="infoline"><div align=center>
		               <html:image src="images/tinybutton-add1.gif" styleClass="tinybutton" property="methodToCall.addNonEmployeeExpenseLine" alt="Add Expense Line" title="Add Expense Line"/>
	              </div></td>
            </tr>
            </c:if>
            ...
            <logic:iterate indexId="ctr" name="KualiForm" property="document.dvNonEmployeeTravel.dvNonEmployeeExpenses" id="currentLine">
                ...
                <tr>
				  ...
				  <c:if test="${fullEntryMode||travelEntryMode}">
	                  <td><div align=center>
	                     <html:image src="images/tinybutton-delete1.gif" styleClass="tinybutton" property="methodToCall.deleteNonEmployeeExpenseLine.line${ctr}" alt="Delete Expense Line" title="Delete Expense Line"/>
	                  </div></td>
				  </c:if>
                </tr>
           </logic:iterate>
            ...
            <tr>
              ...
              <td valign=top nowrap class="infoline"><div align="center">
	            ...
	            <td class="infoline"><div align=center>
	              <html:image src="images/tinybutton-add1.gif" styleClass="tinybutton" property="methodToCall.addPrePaidNonEmployeeExpenseLine" alt="Add Expense Line" title="Add Expense Line"/>
	            </div></td>
            </tr>
            </c:if>
            ...
            <logic:iterate indexId="ctr2" name="KualiForm" property="document.dvNonEmployeeTravel.dvPrePaidEmployeeExpenses" id="currentLine">
                ...
                <tr>
				  ...
				  <c:if test="${fullEntryMode||travelEntryMode}">
	                  <td><div align=center>
	                      <html:image src="images/tinybutton-delete1.gif" styleClass="tinybutton" property="methodToCall.deletePrePaidEmployeeExpenseLine.line${ctr2}" alt="Delete Expense Line" title="Delete Expense Line"/>
	                  </div></td>
                  </c:if>
                </tr>
           </logic:iterate>
