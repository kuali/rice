 ...
 *
 */
public class DocumentPessimisticLockerServiceImpl implements DocumentPessimisticLockerService {
    private static Log LOG = LogFactory.getLog(DocumentPessimisticLockerServiceImpl.class);
