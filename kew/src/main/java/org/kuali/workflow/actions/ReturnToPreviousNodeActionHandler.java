...
/**
 * Implements "returntopreviousnode" action 
 * @author Kuali Rice Team (kuali-rice@googlegroups.com)
 *
 */
public class ReturnToPreviousNodeActionHandler implements ActionHandler {
    /**
     ...
     * @param args String nodeName, Boolean sendNotifications, Boolean runPostprocessor, String overrideActionTaken
     */
    public void invoke(DocumentRouteHeaderValue routeHeader, WorkflowUser user, String annotation, Object... args) throws InvalidActionTakenException, EdenUserNotFoundException {
        ReturnToPreviousNodeAction action = new ReturnToPreviousNodeAction((String) args[3], routeHeader, user, annotation, (String) args[0], (Boolean) args[1], (Boolean) args[2]);
