...
/**
 * Struts ActionForm for the {@link RouteQueueAction}.
 *
 * @author rkirkend
 */
public class RouteQueueForm extends ActionForm {
    
	private static final long serialVersionUID = -247925603792980036L;
    private int maxRows;
    private Long routeQueueId;
    private String methodToCall = "";
    private Collection<PersistedMessage> routeQueueRows;
    private String showEdit;
    private String command;
    private PersistedMessage routeQueueFromDatabase;
    private PersistedMessage routeQueueFromForm;
    ...
    public RouteQueueForm() {
        routeQueueFromForm = new PersistedMessage();
        maxRows = EdenConstants.MAX_RETURNED_ROWS;
    }
    ...
    public Collection<PersistedMessage> getRouteQueueRows() {
        return routeQueueRows;
    }
 
    public void setRouteQueueRows(Collection<PersistedMessage> routeQueueRows) {
        this.routeQueueRows = routeQueueRows;
    }
    
    public int getRouteQueueRowsSize() {
        if (routeQueueRows == null) {
            return 0;
        }
        return routeQueueRows.size();
    }
    ...
    public PersistedMessage getRouteQueueFromDatabase() {
        return routeQueueFromDatabase;
    }

    public void setRouteQueueFromDatabase(PersistedMessage existingRouteQueue) {
        this.routeQueueFromDatabase = existingRouteQueue;
    }
  
    public PersistedMessage getRouteQueueFromForm() {
        return routeQueueFromForm;
    }

    public void setRouteQueueFromForm(PersistedMessage routeQueue) {
        this.routeQueueFromForm = routeQueue;
    }
