...
public class SaveActionEventTest extends KEWTestCase {
    ...
    @Test public void testSaveActionEvent() throws Exception {
        ...
        document = new WorkflowDocument(getPrincipalNameForId("ewestfal"), DOCUMENT_TYPE_NAME);
        document.saveDocument("");
        assertTrue("Document should be saved.", document.stateIsSaved());
    ...
    @Test public void testFalseInitiatorMustSavePolicy() throws Exception {
        WorkflowDocument document = new WorkflowDocument(getPrincipalNameForId("ewestfal"), DOCUMENT_TYPE_NAME_NON_INITIATOR);
        document.saveRoutingData();
        ...
        try {
            ...
            e.printStackTrace();
            fail("A WorkflowException should not have been thrown.");
        }
