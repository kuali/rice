...
public class DocumentSearchTest extends WorkflowTestCase {
    ...
    @Test public void testSearchEDENSERVICE_DOCS() throws Exception {
        loadXmlStream(new FileInputStream("conf/bootstrap/BootstrapData.xml"));
...
//        loadXmlStream(new FileInputStream("conf/bootstrap/BootstrapRuleContent.xml"));
    ...
    @Test public void testDefaultCreateDateSearchCriteria() throws Exception {
        ...
        assertEquals("Criteria date minus today's date should equal the constant value", EdenConstants.DOCUMENT_SEARCH_NO_CRITERIA_CREATE_DATE_DAYS_AGO.doubleValue(), getDifferenceInDays(today, criteriaDate));
        ...
        criteriaDate.setTime(DocSearchUtils.convertStringDateToTimestamp(criteria.getFromDateCreated()));
        assertEquals("Criteria date minus today's date should equal the constant value", EdenConstants.DOCUMENT_SEARCH_DOC_TITLE_CREATE_DATE_DAYS_AGO.doubleValue(), getDifferenceInDays(today, criteriaDate));
    }
