...
public class UifComponentsKitchenSinkInputFieldsAft extends WebDriverLegacyITBase {
	...
	protected void navigate() throws Exception {
        ...
        waitAndClickByXpath("//a[@id='UifCompView-Navigation1']");
	}
    ...
    protected void testInputFields() throws InterruptedException {
    	//Label
        waitAndClickByXpath("//a[@data-linkfor='UifCompView-TextFields_disclosureContent']");
    	...
    	waitForElementPresentByXpath("//input[@name='date2' and @disabled]");
    	...
    	waitForElementPresentByXpath("//input[@name='field133' and @disabled]");
