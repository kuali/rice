...
public class ErrorReport {
    ...
    public ErrorReport(int ErrorStatus){
        LOG.debug("Creating New Error Report with status: "+ErrorStatus);
    ...
    public ErrorReport(int errorStatus, String validationFailed, String beanLocation, String values[]){
        LOG.debug("Creating New Error Report (single line) with status: "+errorStatus);
        this.errorStatus=errorStatus;
    ...
    public void setValidationFailed(String validation){
        LOG.debug("Setting Validation Failed: "+validation);
    ...
    public void setBeanLocation(String location){
        LOG.debug("Setting Bean Location "+location);
    ...
    public int getErrorStatus(){
        LOG.debug("Retrieving ErrorStatus: "+errorStatus);
        return errorStatus;
    }
    ...
    public String getValidationFailed(){
        LOG.debug("Retrieving Validation Failed: "+validationFailed);
    ...
    public String getBeanLocation(){
        LOG.debug("Retrieving Bean Location: "+beanLocation);
        return beanLocation;
    }
    ...
    public String getCurrentValue(int index){
        LOG.debug("Retrieving Current Value ("+index+") = "+currentValues.get(index));
    ...
    public String getXmlPage(int index){
        LOG.debug("Retrieving xml page ("+index+") = "+xmlPages.get(index));
    ...
    public int getCurrentValueSize(){
        LOG.debug("Number of Current Value = "+currentValues.size());
    ...
    public int getXmlPageSize(){
        LOG.debug("Number of xml pages = "+xmlPages.size());
    ...
    public void addCurrentValue(String value){
        LOG.debug("Adding Current Value = "+value);
    ...
    public void addXmlPage(String page){
        LOG.debug("Adding xml page = "+page);
        xmlPages.add(page);
    }
