...
public class Constants extends JstlConstants {
    ...
    public enum NoteTypeEnum {
        ...
        public String getFullPath() {
            return Constants.DOCUMENT_PROPERTY_NAME+"."+getPath();
        }
    }
    ...
    public static class CashReceiptConstants {
        ...
        public static final String CASH_RECEIPT_DOC_HEADER_STATUS_CODE_PROPERTY_NAME = Constants.DOCUMENT_HEADER_PROPERTY_NAME + "." + Constants.DOCUMENT_HEADER_DOCUMENT_STATUS_CODE_PROPERTY_NAME;
    }
    ...
    public static class BudgetConstructionConstants {
        ...
        /*  Constants for the CSF Tracker  */
        public static final String ACTIVE_CSF_DELETE_CODE = "-";
        
        /*  Constants for the budget construction flag names */
