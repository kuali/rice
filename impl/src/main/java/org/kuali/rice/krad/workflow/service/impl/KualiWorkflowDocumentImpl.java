...
public class KualiWorkflowDocumentImpl implements KualiWorkflowDocument, Serializable {
    ...
    public boolean isAdHocRequested() {
        ...
        try {
            ...
            workflowInfo = KRADServiceLocatorWeb.getWorkflowInfoService();
    ...
    /**
     * 
     * @see org.kuali.rice.krad.workflow.service.KualiWorkflowDocument#userIsInitiator(org.kuali.rice.krad.bo.user.KualiUser)
     */
    ...
    /**
     * 
     * @see org.kuali.rice.krad.workflow.service.KualiWorkflowDocument#userIsRoutedByUser(org.kuali.rice.krad.bo.user.KualiUser)
     */
