...
public interface WorkflowDocumentActions {
    ...
    public RouteHeaderDTO takeWorkgroupAuthority(UserIdDTO userId, RouteHeaderDTO routeHeader, WorkgroupIdDTO workgroupId, String annotation) throws WorkflowException;
    public RouteHeaderDTO releaseWorkgroupAuthority(UserIdDTO userId, RouteHeaderDTO routeHeader, WorkgroupIdDTO workgroupId, String annotation) throws WorkflowException;
