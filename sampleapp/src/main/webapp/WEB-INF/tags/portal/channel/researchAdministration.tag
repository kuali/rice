...
<channel:portalChannelTop channelTitle="Research Administration" />
<div class="body">
    <ul class="chan">
        <li><portal:portalLink displayTitle="true" title="Budget" url="researchBudgetParameters.do?methodToCall=docHandler&command=initiate&docTypeName=KualiBudgetDocument" /></li>
