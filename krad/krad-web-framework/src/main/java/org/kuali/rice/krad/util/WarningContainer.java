...
public class WarningContainer extends MessageContainer {
	 ...
	 * 
	 * @see org.kuali.rice.krad.util.MessageContainer#getMessageCount()
	 */
	@Override
	...
	/**
	 * @see org.kuali.rice.krad.util.MessageContainer#getMessagePropertyNames()
	 */
	@Override
	...
	/**
	 * @see org.kuali.rice.krad.util.MessageContainer#getMessagePropertyList()
	 */
	@Override
	...
	/**
	 * @see org.kuali.rice.krad.util.MessageContainer#getMessagesForProperty(java.lang.String)
	 */
	@Override
