...
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', '1821D8BAB21E498F9FB1ECCA25C37F9B', 'ActionList', 'Action List')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', 'F7E44233C2C440FFB1A399548951160A', 'Backdoor', 'Backdoor')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', '18695E69ED0D4FBE8B084FCA8066D21C', 'DocumentSearch', 'Document Search ')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', '51DD5B9FACDD4EDAA9CA8D53A82FCCCA', 'EDocLite  ', 'eDocLite')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', 'BBD9976498A4441F904013004F3D70B3', 'Feature', 'Feature')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', 'C21B0C6229144F6FBC52A10A38E51E3B', 'GlobalReviewer', 'Global Reviewer')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', '5DB9D1433E214325BE380C82762A223B', 'Mailer', 'Mailer')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', '868D39EC269B4402B3136C74C2342F22', 'Note', 'Note')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', '3E26DA76458A46D68CBAF209DA036157', 'QuickLink', 'Quick Link')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', 'D4F6DDEF69B24265AA2A170A62A1CADB', 'RouteQueue', 'Route Queue')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', '583C2D3562D44DBAA5FEA998EB601DC9', 'Route', 'Routing')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', 'FC831215ED534549845BCE2C59B16FD9', 'Rule', 'Rule')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', 'A8FBD6D9A72347CFBB47994C35A45A5F', 'RuleService', 'Rule Service')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', 'FB2565730CB74E3C9077A8B8CF3E4618', 'RuleTemplate', 'Rule Template')
/
Insert into KRNS_PARM_DTL_TYP_T ("NMSPC_CD", "OBJ_ID", "PARM_DTL_TYP_CD", "NM") VALUES ('KR-WRKFLW', 'D04AFB1812E34723ABEB64986AC61DC9', 'Workgroup', 'Workgroup')
/
...
/
INSERT INTO KRNS_PARM_T ("NMSPC_CD", "OBJ_ID","PARM_DTL_TYP_CD","PARM_NM","PARM_TYP_CD","TXT","PARM_DESC_TXT","CONS_CD","GRP_NM") VALUES ('KR-WRKFLW', '7ADC4995AB7E47299A13A5B66E495683', 'DocumentType', 'DOCUMENT_TYPE_SEARCH_INSTRUCTION', 'CONFG', 'Enter document type information below and click search.', 'Instructions for searching document types.', 'A', 'WorkflowAdmin')
/
INSERT INTO KRNS_PARM_T ("NMSPC_CD", "OBJ_ID","PARM_DTL_TYP_CD","PARM_NM","PARM_TYP_CD","TXT","PARM_DESC_TXT","CONS_CD","GRP_NM") VALUES ('KR-WRKFLW', '68B2EA08E13A4FF3B9EDBD5415818C93', 'EDocLite', 'DEBUG_TRANSFORM_IND', 'CONFG', 'N', 'Defines whether the debug transform is enabled for eDcoLite.', 'A', 'WorkflowAdmin')
/
...
/
INSERT INTO KRNS_PARM_T ("NMSPC_CD", "OBJ_ID","PARM_DTL_TYP_CD","PARM_NM","PARM_TYP_CD","TXT","PARM_DESC_TXT","CONS_CD","GRP_NM") VALUES ('KR-WRKFLW', '09ECF812733D499C906ACBE17F13AFEE', 'RuleTemplate', 'RULE_TEMPLATE_CREATE_NEW_INSTRUCTION', 'CONFG', 'Enter a rule template name and description. Please select all necessary rule attributes for this template.', 'Instructions for creating new rule templates.', 'A', 'WorkflowAdmin')
/
