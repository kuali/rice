...
public class MaintainableFieldDefinition extends MaintainableItemDefinition implements FieldDefinitionI{
    ...
    private Class<ValueFinder> defaultValueFinderClass;
    ...
    private Class<BusinessObject> overrideLookupClass;
     ...
     */
    public Class<ValueFinder> getDefaultValueFinderClass() {
    ...
    public void setDefaultValueFinderClass(Class<ValueFinder> defaultValueFinderClass) {
        this.defaultValueFinderClass = defaultValueFinderClass;
    }


    public void setOverrideLookupClass(Class<BusinessObject> overrideLookupClass) {
