...
public class DataDictionary {
    ...
    protected void generateMissingLookupDefinitions() {
        ...
        for (DataObjectEntry entry : ddBeans.getBeansOfType(DataObjectEntry.class).values()) {
            ...
            lookupBean.setAttribute("dataObjectClassName", lookupView.getDataObjectClassName());
            lookupBean.getPropertyValues().add("dataObjectClassName", lookupView.getDataObjectClassName().getName());
