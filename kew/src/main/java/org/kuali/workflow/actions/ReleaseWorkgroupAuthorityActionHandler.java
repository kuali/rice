...
/**
 * Implements "releaseworkgroupauthority" action 
 * @author Kuali Rice Team (kuali-rice@googlegroups.com)
 *
 */
public class ReleaseWorkgroupAuthorityActionHandler implements ActionHandler {
    /**
    ...
    public void invoke(DocumentRouteHeaderValue routeHeader, WorkflowUser user, String annotation, Object... args) throws InvalidActionTakenException, EdenUserNotFoundException {
        ReleaseWorkgroupAuthority action = new ReleaseWorkgroupAuthority(routeHeader, user, annotation, (Workgroup) args[0]);
