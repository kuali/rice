...
/
ALTER TABLE KRIM_PERM_T RENAME COLUMN DESCRIPTION TO DESC
/
...
/
ALTER TABLE KRIM_PERM_TMPL_T RENAME COLUMN DESCRIPTION TO DESC
/
...
/
ALTER TABLE KRIM_RSP_T RENAME COLUMN DESCRIPTION TO DESC
/
...
/
ALTER TABLE KRIM_RSP_TMPL_T RENAME COLUMN DESCRIPTION TO DESC
/
...
/
ALTER TABLE KRIM_ROLE_T RENAME COLUMN ROLE_DESC TO DESC
/
...
/
CREATE SEQUENCE KRIM_ATTR_DATA_ID_S START WITH KR_KIM_ATTRIB_DATA_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ATTRIB_DATA_ID_SEQ
/
 CREATE SEQUENCE KRIM_ATTR_DEFN_ID_S START WITH KR_KIM_ATTRIB_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ATTRIB_ID_SEQ
/
 CREATE SEQUENCE KRIM_DLGN_ID_S START WITH KR_KIM_DELE_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_DELE_ID_SEQ
/
 CREATE SEQUENCE KRIM_DLGN_MBR_ID_S START WITH KR_KIM_DELE_MBR_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_DELE_MBR_ID_SEQ
/
 CREATE SEQUENCE KRIM_ENTITY_ADDR_ID_S START WITH KR_KIM_ENTITY_ADDR_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ENTITY_ADDR_ID_SEQ
/
 CREATE SEQUENCE KRIM_ENTITY_AFLTN_ID_S START WITH KR_KIM_ENTITY_AFLTN_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ENTITY_AFLTN_ID_SEQ
/
 CREATE SEQUENCE KRIM_ENTITY_CTZNSHP_ID_S START WITH KR_KIM_ENTITY_CTZNSHP_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ENTITY_CTZNSHP_ID_SEQ
/
 CREATE SEQUENCE KRIM_ENTITY_EMAIL_ID_S START WITH KR_KIM_ENTITY_EMAIL_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ENTITY_EMAIL_ID_SEQ
/
 CREATE SEQUENCE KRIM_ENTITY_EMP_ID_S START WITH KR_KIM_ENTITY_EMP_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ENTITY_EMP_ID_SEQ
/
 CREATE SEQUENCE KRIM_ENTITY_ENT_TYP_ID_S START WITH KR_KIM_ENTITY_ENT_TYPE_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ENTITY_ENT_TYPE_ID_SEQ
/
 CREATE SEQUENCE KRIM_ENTITY_EXT_ID_ID_S START WITH KR_KIM_ENTITY_EXT_ID_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ENTITY_EXT_ID_ID_SEQ
/
 CREATE SEQUENCE KRIM_ENTITY_ID_S START WITH KR_KIM_ENTITY_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ENTITY_ID_SEQ
/
 CREATE SEQUENCE KRIM_ENTITY_NM_ID_S START WITH KR_KIM_ENTITY_NAME_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ENTITY_NAME_ID_SEQ
/
 CREATE SEQUENCE KRIM_ENTITY_PHONE_ID_S START WITH KR_KIM_ENTITY_PHONE_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ENTITY_PHONE_ID_SEQ
/
 CREATE SEQUENCE KRIM_GRP_ID_S START WITH KR_KIM_GROUP_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_GROUP_ID_SEQ
/
 CREATE SEQUENCE KRIM_GRP_MBR_ID_S START WITH KR_KIM_GROUP_MEMBER_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_GROUP_MEMBER_ID_SEQ
/
 CREATE SEQUENCE KRIM_PERM_ID_S START WITH KR_KIM_PERM_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_PERM_ID_SEQ
/
 CREATE SEQUENCE KRIM_PERM_TMPL_ID_S START WITH KR_KIM_PERM_TMPL_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_PERM_TMPL_ID_SEQ
/
 CREATE SEQUENCE KRIM_PRNCPL_ID_S START WITH KR_KIM_PRNCPL_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_PRNCPL_ID_SEQ
/
 CREATE SEQUENCE KRIM_RSP_ID_S START WITH KR_KIM_RESP_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_RESP_ID_SEQ
/
 CREATE SEQUENCE KRIM_RSP_TMPL_ID_S START WITH KR_KIM_RESP_TMPL_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_RESP_TMPL_ID_SEQ
/
 CREATE SEQUENCE KRIM_ROLE_ID_S START WITH KR_KIM_ROLE_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ROLE_ID_SEQ
/
 CREATE SEQUENCE KRIM_ROLE_MBR_ID_S START WITH KR_KIM_ROLE_MEMBER_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ROLE_MEMBER_ID_SEQ
/
 CREATE SEQUENCE KRIM_ROLE_PERM_ID_S START WITH KR_KIM_ROLE_PERM_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ROLE_PERM_ID_SEQ
/
 CREATE SEQUENCE KRIM_ROLE_REL_ID_S START WITH KR_KIM_ROLE_REL_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ROLE_REL_ID_SEQ
/
 CREATE SEQUENCE KRIM_ROLE_RSP_ACTN_ID_S START WITH KR_KIM_ROLE_RESP_ACTN_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ROLE_RESP_ACTN_ID_SEQ
/
 CREATE SEQUENCE KRIM_ROLE_RSP_ID_S START WITH KR_KIM_ROLE_RESP_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ROLE_RESP_ID_SEQ
/
 CREATE SEQUENCE KRIM_ROLE_RSP_RESOL_ID_S START WITH KR_KIM_ROLE_RESP_RESOL_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_ROLE_RESP_RESOL_ID_SEQ
/
 CREATE SEQUENCE KRIM_TYP_ATTR_ID_SEQ START WITH KR_KIM_TYPE_ATTRIB_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_TYPE_ATTRIB_ID_SEQ
/
 CREATE SEQUENCE KRIM_TYP_ID_S START WITH KR_KIM_TYPE_ID_SEQ.NEXTVAL 
/
 DROP SEQUENCE KR_KIM_TYPE_ID_SEQ
/
