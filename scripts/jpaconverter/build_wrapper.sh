...
groovy \
	-classpath ../../../target/classes:$MAVEN_REPO/com/google/code/javaparser/javaparser/1.0.9/javaparser-1.0.9.jar:$MAVEN_REPO/org/kuali/db/ojb/db-ojb/1.0.4-patch9/db-ojb-1.0.4-patch9.jar \
    ...
    --addjar    $MAVEN_REPO/org/kuali/db/ojb/db-ojb/1.0.4-patch9/db-ojb-1.0.4-patch9.jar \
