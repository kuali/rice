...
import org.kuali.rice.kim.service.dao.KimDao;
...
public class KimServiceImpl implements KimService {
    ...
    private KimDao kimDao;
    
    public AttributeType getAttributeType(Long attributeTypeId) {
	return getKimDao().getAttributeType(attributeTypeId);
    }

    public void saveAttributeType(AttributeType attributeType) {
	getKimDao().saveAttributeType(attributeType);
    }

    public KimDao getKimDao() {
        return this.kimDao;
    }

    public void setKimDao(KimDao kimDao) {
        this.kimDao = kimDao;
    }
