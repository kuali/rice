...
@Table(name = "KRIM_HIST_CTZNSHP_CHNG_TYP_T")
public class EntityCitizenshipChangeTypeHistoryBo extends EntityCitizenshipChangeTypeBo implements CodedAttributeHistoryBoContract {
    private static final long serialVersionUID = 6439539790312966370L;
    @Id
    @GeneratedValue(generator = "KRIM_HIST_CTZNSHP_ID_S")
    @PortableSequenceGenerator(name = "KRIM_HIST_CTZNSHP_ID_S")
    @Column(name ="HIST_ID")
    ...
    public static CodedAttributeHistory to(EntityCitizenshipChangeTypeHistoryBo bo) {
        if (bo == null) {
            return null;
        }
    ...
    public static EntityCitizenshipChangeTypeHistoryBo from(CodedAttributeHistory immutable) {
        return CodedAttributeHistoryBoUtil.from(EntityCitizenshipChangeTypeHistoryBo.class, immutable);
    }

    public static EntityCitizenshipChangeTypeHistoryBo from(CodedAttribute immutable,
            Timestamp fromDate,
            Timestamp toDate) {
        return CodedAttributeHistoryBoUtil.from(EntityCitizenshipChangeTypeHistoryBo.class, immutable, fromDate, toDate);
    }
