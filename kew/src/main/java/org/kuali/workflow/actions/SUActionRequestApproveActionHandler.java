...
/**
 * Implements the "suactionrequestapprove" action 
 * @author Kuali Rice Team (kuali-rice@googlegroups.com)
 */
public class SUActionRequestApproveActionHandler implements ActionHandler {
    /**
     ...
     * @param args Long actionRequestId, Boolean runPostProcessor
     */
    public void invoke(DocumentRouteHeaderValue routeHeader, WorkflowUser user, String annotation, Object... args) throws InvalidActionTakenException, EdenUserNotFoundException {
        SuperUserActionRequestApproveEvent action = new SuperUserActionRequestApproveEvent(routeHeader, user, (Long) args[0], annotation, (Boolean) args[1]);
