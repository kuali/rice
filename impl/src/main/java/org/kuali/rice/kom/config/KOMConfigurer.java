 ...
 */
public class KOMConfigurer extends ModuleConfigurer {
    	private static final Logger LOG = Logger.getLogger(KOMConfigurer.class);
	...
	@Override
    	public Config loadConfig(Config parentConfig) throws Exception {
    	    	LOG.info("Starting configuration of KOM for message entity " + parentConfig.getMessageEntity());
	...
	protected List<Lifecycle> loadLifecycles() throws Exception {
		...
		lifecycles.add(new KOMOjbConfigurer());

		lifecycles.add(KOMResourceLoaderFactory.createRootKOMResourceLoader());
