 ...
 */
public class PropertyTreeTest extends KNSTestCase {
    ...
    @Test public void testGet_chainedGet() throws Exception {
        ...
        String value = ((PropertyTree) ((PropertyTree) tree.get("known")).get("complex")).get("key").toString();
