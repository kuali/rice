...
VALUES('KRSAP2100', '27', 'KR-SYS', 'Full Unmask TravelerDetail Phone', 'Authorizes users to view the entire Phone Number on the Travel Detail document and inquiry.','Y', uuid(), 1)
/
...
INSERT INTO KRIM_PERM_T (PERM_ID, PERM_TMPL_ID, NMSPC_CD, NM, DESC_TXT, ACTV_IND, OBJ_ID, VER_NBR)
VALUES('KRSAP2200', '28', 'KR-SYS', 'Partial Unmask TravelerDetail Phone', 'Authorizes users to paritally view the Phone Number on the Travel Detail document and inquiry.','Y', uuid(), 1)
/
