...
<xsl:stylesheet version="1.0"
	...
	<!--                           VERSION HISTORY
		- 03/2007: pcberg@indiana.edu, refactoring for KRA.
		- Added variable baseUrl.
		- Merged RS_Business.xsl dependency into this stylesheet.
		- Added / Removed / Modified fields per KRA implementation.
	-->
	...
	<xsl:variable name="risk"
		select="PROPOSAL/ROUTING_FORM/RESEARCH_RISK" />
						...
						<fo:table-body font-size="9pt">
							...
							<fo:table-row height="5mm">
								...
								<fo:table-cell
									...
									<fo:block
										white-space-collapse="false">
										<xsl:value-of
											select="substring(concat($lastNamePrincipal,', ',$firstNamePrincipal), 1, 20)" />
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row>
								...
								<fo:table-cell
									...
									<fo:block text-align="right">
										<xsl:value-of
											select="substring($submittingOrg,0,25)" />
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row>
								...
								<fo:table-cell
									...
									<fo:block wrap-option="no-wrap">
										Campus Address:
										<xsl:value-of
											select="substring($principals/PROJECT_DIRECTOR/PD_CAMPUS_ADDRESS,1,40)" />
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell>
									<fo:block>
										<xsl:call-template
											name="ToggleInstruction" />
									</fo:block>

								</fo:table-cell>

								<fo:table-cell
									number-columns-spanned="7" display-align="after">
							...
							<fo:table-row>
								...
								<fo:table-cell
									...
									<fo:block>
										Phone:
										<xsl:value-of
											select="substring($principals/PROJECT_DIRECTOR/PD_PHONE,1,40)" />
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									...
									<fo:block text-align="right">
										E-mail:
										<xsl:value-of
											select="substring($principals/PROJECT_DIRECTOR/PD_EMAIL,1,40)" />
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="3" padding-top="1mm">
									<fo:block>
										Service /
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="6" number-rows-spanned="4"
									padding-top="1mm">
									<fo:block>
										Other:
										<xsl:value-of
											select="substring($purpose/PURPOSE_DESCRIPTION, 1, 100)" />
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
								...
								<fo:table-cell>
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$type/@NEW" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm">
								...
								<fo:table-cell>
									<fo:block>
										<xsl:call-template
											...
											<xsl:with-param
												name="checkboxNode"
												select="$type/@RENEWAL-NOT_PREVIOUSLY_COMMITTED" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="8" display-align="after">
									<fo:block text-indent="1.5mm">
										Renewal - Not Previously Committed
									</fo:block>
								</fo:table-cell>

								<fo:table-cell
									xsl:use-attribute-sets="ab" number-columns-spanned="3"
								...
								<fo:table-cell
									number-columns-spanned="10" xsl:use-attribute-sets="bc"
									display-align="center">
									<fo:block>
										<xsl:value-of
											select="$type/PRIOR_GRANT" />
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm">
								...
								<fo:table-cell>
									<fo:block>
										<xsl:call-template
											...
											<xsl:with-param
												name="checkboxNode"
												select="$type/@RENEWAL-PREVIOUSLY_COMMITTED" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									xsl:use-attribute-sets="a" number-columns-spanned="3"
									display-align="center">
									<fo:block text-indent="2mm">
										Current Grant
										<xsl:text
								...
								<fo:table-cell
									number-columns-spanned="10" xsl:use-attribute-sets="c"
									display-align="center">
									<fo:block>
										<xsl:value-of
											select="$type/CURRENT_GRANT" />
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm">
								...
								<fo:table-cell>
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$type/@SUPPLEMENTAL_FUNDS" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:value-of
											select="$type/INSTITUTION_ACCOUNT" />
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm">
								...
								<fo:table-cell>
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$type/@TIME_EXTENSION" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									xsl:use-attribute-sets="ad" number-columns-spanned="3"
									display-align="after">
									<fo:block text-indent="2mm">
								...
								<fo:table-cell
									number-columns-spanned="10" xsl:use-attribute-sets="cd"
									display-align="after">
									<fo:block>
										<xsl:value-of
											select="$type/CURRENT_PROPOSAL" />
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm">
								...
								<fo:table-cell>
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$type/@BUDGET_REVISION_ACTIVE" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="21" display-align="after">
									<fo:block text-indent="1.5mm">
										Budget revision to active
										project
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell>
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$type/@BUDGET_REVISION_PENDING" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm">
								...
								<fo:table-cell>
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$type/@OTHER" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="13" number-rows-spanned="2"
									padding-top="1.2mm">
									<fo:block>
										<xsl:value-of
											select="$type/@OTHER_DESCRIPTION" />
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$risk/@HUMAN_SUBJECTS_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									...
									<fo:block text-indent="5mm">
										...
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$risk/@ANIMAL_IND" />
										</xsl:call-template>
								...
								<fo:table-cell
									...
									<fo:block text-indent="5mm">
										...
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$risk/@BIOSAFETY_IND" />
										</xsl:call-template>
							...
							<fo:table-row height="4mm"
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$risk/@HUMAN_TISSUE_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="19">
									<fo:block>
										Human Tissue or Fluids:
										<xsl:if
											test="not($risk/@HUMAN_TISSUE_TYPE = 'Z' )">
											<xsl:value-of
												select="$risk/@HUMAN_TISSUE_TYPE" />
										</xsl:if>
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm"
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$risk/@PATHOGENIC_AGENTS_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									...
									<fo:block>
										Pathogenic Agents:
										<xsl:if
											test="not($risk/@PATHOGENIC_AGENTS_TYPE = 'Z')">
											<xsl:value-of
												select="$risk/@PATHOGENIC_AGENTS_TYPE" />
										</xsl:if>
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm"
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											...
											<xsl:with-param
												name="checkboxNode"
												select="$risk/@CONFLICT_OF_INTEREST_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="18">
									<fo:block>
										Does any individual responsible
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$details/@COST_SHARE_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm"
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											...
											<xsl:with-param
												name="checkboxNode"
												select="$details/@FEDERAL_PASS_THROUGH_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="18">
									<fo:block>
										Federal pass-through source:
										<xsl:value-of
											select="$details/FED_PASS_THROUGH_SOURCE" />
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$details/@OFF_CAMPUS" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$details/@PROGRAM_INCOME_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$details/@SUBCONTRACTS" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm"
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$details/@INVENTIONS_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="18">
									<fo:block>
										Inventions have been conceived
										or reduced to practice under
							...
							<fo:table-row height="4mm"
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$details/@NEW_SPACE_REQ_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="18">
									<fo:block>
										New space or remodeling will be
										required
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm"
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											...
											<xsl:with-param
												name="checkboxNode"
												select="$details/@INTERNATIONAL_COLLAB_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="18">
									<fo:block>
										Project involves collaborative
										activities with foreign partner
										or has an international focus
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm"
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											name="Toggle">
											<xsl:with-param
												name="checkboxNode" select="$details/@FOREIGN_TRAVEL_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="18">
									<fo:block>
										Project requires foreign travel
									</fo:block>
								</fo:table-cell>
							...
							<fo:table-row height="4mm"
								...
								<fo:table-cell
									...
									<fo:block>
										<xsl:call-template
											...
											<xsl:with-param
												name="checkboxNode"
												select="$details/@OTHER_UNIV_INVOLVMENT_IND" />
										</xsl:call-template>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell
									number-columns-spanned="18">
									<fo:block>
										Other Institution campuses, schools, or units are involved
									</fo:block>
								</fo:table-cell>
							...
							<xsl:apply-templates
								select="PROPOSAL/ROUTING_FORM/APPROVALS/APPROVER" />
							...
							<!-- Those variables define the existance (or non existance)
								...
								the conditions. -->
							<xsl:variable name="RESEARCH_RISKS_SET"
								select="(PROPOSAL/ROUTING_FORM/RESEARCH_RISK/@HUMAN_SUBJECTS_IND = 'Y') or (PROPOSAL/ROUTING_FORM/RESEARCH_RISK/@ANIMAL_IND = 'Y') or (PROPOSAL/ROUTING_FORM/RESEARCH_RISK/@BIOSAFETY_IND = 'Y')" />
							<xsl:variable name="COST_SHARE_SET"
								select="$details/@COST_SHARE_IND = 'Y'" />
							<xsl:variable name="SUBCONTRACTS_SET"
								select="$details/@SUBCONTRACTS = 'Y'" />
							<xsl:variable name="CO-PD_SET"
								select="$principals/@CO-PD_IND = 'Y'" />
							<xsl:variable name="OTHER_SET"
								select="$details/@OTHER_UNIV_INVOLVMENT_IND = 'Y'" />
							<xsl:variable name="COMMENTS_SET"
								select="count(PROPOSAL/ROUTING_FORM/COMMENTS/COMMENT) > 0" />
							...
							<xsl:if test="not(/PROPOSAL/ROUTING_FORM/AGENCY/AGENCY_DELIVERY/ADDITIONAL_DELIVERY_INSTRUCTIONS = '')">
								<fo:table-row height="5mm">
							...
							<xsl:if test="$RESEARCH_RISKS_SET">
								...
								<fo:table-row keep-with-next="always"
									...
									<fo:table-cell
										xsl:use-attribute-sets="abcd" number-columns-spanned="2"
										display-align="center" padding-top="0.9mm">
										<fo:block text-indent="1mm">
											<fo:inline
												font-weight="bold">
								...
								<xsl:apply-templates
									select="PROPOSAL/ROUTING_FORM/RESEARCH_RISK/STUDY" />
								...
								<fo:table-row height="6mm">
									...
									<fo:table-cell
										...
										<fo:block text-indent="1mm">
											$
											<xsl:value-of
												select="format-number(sum(PROPOSAL/ROUTING_FORM/PROJECT_DETAIL/IU_COST_SHARE/@AMOUNT [. &gt; 0]), '###,###'  )" />
										</fo:block>
									</fo:table-cell>
								...
								<fo:table-row keep-with-next="always"
									...
									<fo:table-cell
										...
										<fo:block text-indent="1mm"
											...
											$
											<xsl:value-of
												select="format-number(sum(PROPOSAL/ROUTING_FORM/PROJECT_DETAIL/IU_COST_SHARE/@AMOUNT [. &gt; 0]) +  sum($details/OTHER_COST_SHARE/@AMOUNT[. &gt; 0]), '###,###'  )" />
										</fo:block>
									</fo:table-cell>
							...
							<xsl:if test="$CO-PD_SET">
								...
								<fo:table-row height="6mm">
									...
									<fo:table-cell
										xsl:use-attribute-sets="abd" number-columns-spanned="20"
										display-align="center" padding-top="0.9mm">
										<fo:block text-indent="1mm">
											<fo:inline
												font-weight="bold">
							...
							<xsl:if test="$OTHER_SET">
								...
								<fo:table-row keep-with-next="always"
									...
									<fo:table-cell
										xsl:use-attribute-sets="abcd" number-columns-spanned="18"
										display-align="center" padding-top="0.9mm">
										<fo:block text-indent="1mm">
											<fo:inline
												font-weight="bold">
							...
							<xsl:apply-templates
								select="PROPOSAL/ROUTING_FORM/PROJECT_DETAIL/PERCENT_CREDIT"
								mode="three" />

							<fo:table-row height="6mm" />

							<!-- KEYWORDS TABLE -->
							<xsl:if test="count(PROPOSAL/ROUTING_FORM/KEYWORDS/KEYWORD) > 0">
								<fo:table-row keep-with-next="always"
									height="6mm">
									<fo:table-cell
										number-columns-spanned="22">
		...
		<fo:table-row height="6mm">
			...
			<fo:table-cell xsl:use-attribute-sets="abd"
				...
				<fo:block text-indent="1mm">
					...
					<xsl:if test=" STUDY_TYPE = 'H' ">Human</xsl:if>

					<xsl:if test=" STUDY_TYPE = 'A' ">Animal</xsl:if>
	...
	<xsl:template
		match="PROPOSAL/ROUTING_FORM/PROJECT_DETAIL/SUBCONTRACTOR">
	...
	<xsl:template
		...
		<fo:table-row height="6mm">
			...
			<fo:table-cell xsl:use-attribute-sets="abd"
				number-columns-spanned="20" display-align="center"
				padding-top="0.9mm">
				<fo:block text-indent="1mm">
					<fo:block text-indent="1mm">
						<xsl:value-of
	...
	<xsl:template
		match="PROPOSAL/ROUTING_FORM/PROJECT_DETAIL/OTHER_UNIV_ORG">
		...
		<fo:table-row height="6mm">
			...
			<fo:table-cell xsl:use-attribute-sets="abcd"
				number-columns-spanned="18" display-align="center"
	...
	<xsl:template
		match="PROPOSAL/ROUTING_FORM/PROJECT_DETAIL/IU_COST_SHARE">
