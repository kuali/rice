...
class FormConverterTest {
    ...
    void testBuildUifForm() {
        ...
        def formBinding = ["package": "edu.sampleu.bookstore.document.web", "author": "rice", "className": "SampleUifForm", "accessModifier": "public", "parentClass": "TransactionalDocumentFormBase", interfaces: [], annotations: [], imports: ["edu.sampleu.bookstore.bo.BookOrder", "edu.sampleu.bookstore.document.BookOrderDocument", "org.kuali.rice.krad.web.form.TransactionalDocumentFormBase"], members: [[accessModifier: "private", nonAccessModifiers: ["static", "final"], fieldType: "final", "fieldName": "serialVersionUID", annotations: [], fieldValue: "-206564464059467788L", text: "    private static final long serialVersionUID = 1L;"], ["accessModifier": "private", nonAccessModifiers: [], "fieldType": "BookOrder", "fieldName": "newBookOrder", annotations: [], fieldValue: null, text: "    private BookOrder newBookOrder;"]], methods: [[accessModifier: "public", nonAccessModifiers: [], "returnType": "BookOrder", "methodName": "getNewBookOrder", parameters: [], exceptions: null, annotations: []], ["accessModifier": "public", nonAccessModifiers: [], "returnType": "void", "methodName": "setNewBookOrder", parameters: ["BookOrder newBookOrder"], exceptions: null, annotations: []], [accessModifier: "public", nonAccessModifiers: [], returnType: "BookOrderDocument", methodName: "getBookOrderDocument", parameters: [], exceptions: null, annotations: []]]]
