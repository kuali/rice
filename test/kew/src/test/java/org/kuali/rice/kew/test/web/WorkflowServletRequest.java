...
public class WorkflowServletRequest extends MockHttpServletRequest {
    ...
    public void setUser(String user) {
        ...
        if (user == null) {
            ...
            wfuser = KIMServiceLocatorInternal.getIdentityService().getPrincipalByPrincipalName(user);
        }
    ...
    public KimPrincipal getWorkflowUser() {
        ...
        return KIMServiceLocatorInternal.getIdentityService().getPrincipalByPrincipalName(session.getLoggedInUserPrincipalName());
    }
