...
public class RiceConstants extends JstlConstants {
    ...
    public static class CashReceiptConstants {
        ...
        public static final String CASH_RECEIPT_DOC_HEADER_STATUS_CODE_PROPERTY_NAME = RiceConstants.DOCUMENT_HEADER_PROPERTY_NAME + "." + RiceConstants.DOCUMENT_HEADER_DOCUMENT_STATUS_CODE_PROPERTY_NAME;
    }
