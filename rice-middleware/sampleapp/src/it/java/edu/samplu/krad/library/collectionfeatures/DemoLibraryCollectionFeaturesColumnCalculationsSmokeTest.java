 ...
 */
public class DemoLibraryCollectionFeaturesColumnCalculationsSmokeTest extends SmokeTestBase {

    /**
     * /kr-krad/kradsampleapp?viewId=Demo-TableLayoutTotaling-View&methodToCall=start
     */
    public static final String BOOKMARK_URL = "/kr-krad/kradsampleapp?viewId=Demo-TableLayoutTotaling-View&methodToCall=start";
...
//        waitAndTypeByName("newCollectionLines['collection1'].field1","");
    ...
    protected void testCollectionFeaturesColumnCalculationsLeftLabel() throws Exception {
        ...
        assertElementPresentByXpath("//div[@id='Demo-TableLayoutTotaling-Section4']/div/table/tfoot/tr/th/div/div[@class='uif-verticalBoxLayout clearfix']/span/label");
    }
    ...
    protected void testCollectionFeaturesColumnCalculationsGroupingCalculations() throws Exception {
        ...
        assertElementPresentByXpath("//div[@id='Demo-TableLayoutTotaling-Section7']/div/table/tbody/tr[7]/td/div/span[@data-role]");
        assertElementPresentByXpath("//div[@id='Demo-TableLayoutTotaling-Section7']/div/table/tbody/tr[7]/td[2]/div/span[@data-role]");
        assertElementPresentByXpath("//div[@id='Demo-TableLayoutTotaling-Section7']/div/table/tbody/tr[7]/td[3]/div/span[@data-role]");
    }
