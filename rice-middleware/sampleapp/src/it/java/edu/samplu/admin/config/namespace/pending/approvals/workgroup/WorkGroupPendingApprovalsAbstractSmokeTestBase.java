 ...
 */
public abstract class WorkGroupPendingApprovalsAbstractSmokeTestBase extends AdminTmplMthdSTNavBase{
    ...
    public void testWorkGroupPendingApprovalsBookmark(Failable failable) throws Exception {
        testWorkGroupPendingApprovals();
        passed();
    }

    public void testWorkGroupPendingApprovalsNav(Failable failable) throws Exception {
        gotoMenuLinkLocator();
        testWorkGroupPendingApprovals();
        passed();
    }
    ...
    protected void testWorkGroupPendingApprovals() throws Exception {
        ...
        waitAndTypeByName(DOCUMENT_CODE_NAME,"SUACTION3");
        waitAndTypeByName(DOCUMENT_NAME,"SUACTION3"+RandomStringUtils.randomAlphabetic(4).toLowerCase());
