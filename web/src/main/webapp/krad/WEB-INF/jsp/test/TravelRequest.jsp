...
<krad:documentPage
    ...
    <krad:hiddenDocumentFields />

    <krad:documentOverview editingMode="${KualiForm.editingMode}" />
            ...
            <tr>
                <td colspan="4">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="datatable">
                        ...
                        <html-el:image property="methodToCall.insertAccount" src="${ConfigProperties.kr.externalizable.images.url}tinybutton-add1.gif" alt="Insert an Item" title="Insert an Item" styleClass="tinybutton"/>
                        </td>
                        </tr>
                        <logic:iterate id="travAcct" name="KualiForm" property="document.travelAccounts" indexId="ctr">
                            <tr>
                                ...
                                <html-el:image property="methodToCall.deleteAccount.(((${ctr})))" src="${ConfigProperties.kr.externalizable.images.url}tinybutton-delete1.gif" alt="Delete an Item" title="Delete an Item" styleClass="tinybutton"/>
                                </td>
                            </tr>
                        </logic:iterate>
                    </table>
