...
/**
 * This is the base HTML Unit Test class that all KOM HTML Unit tests need to extend from. 
 * 
 * @author Kuali Rice Team (kuali-rice@googlegroups.com)
 */
public abstract class KOMHtmlTestBase extends KOMTestCase {
    
    /**
    public void testMaintainable() throws Exception {
	HtmlPage maintPage = HtmlUnitUtil
		.gotoPageAndLogin(HtmlUnitUtil.BASE_URL
	...
	assertTrue("Document not successfully routed", HtmlUnitUtil.pageContainsText(returnPage,
