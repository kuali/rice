...
public class KNSServiceLocator { //extends BaseLifecycle{
    
    private ConfigurableApplicationContext knsApplicationContext;
    private List<ConfigurableApplicationContext> children = new ArrayList<ConfigurableApplicationContext>();
    
    private static KNSServiceLocator instance = new KNSServiceLocator();
    ...
    public static KNSServiceLocator getInstance() {
        return instance;
    }
    ...
    public void setKnsApplicationContext(ConfigurableApplicationContext knsApplicationContext) {
        this.knsApplicationContext = knsApplicationContext;
    }    
    
    public static Object getService(String serviceName) {
//        if (getInstance().getKnsApplicationContext().containsBean(serviceName)) {
            return getInstance().getKnsApplicationContext().getBean(serviceName);    
//        }
//        return getInstance().getChildService(serviceName);
    }
