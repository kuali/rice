...
public class DocumentContentTest extends KEWTestCase {
    ...
    @Test public void testDocumentContentConsistency() throws Exception {
    	...
    	WorkflowDocument document2 = new WorkflowDocument(getPrincipalNameForId("ewestfal"), document.getRouteHeaderId());
    	...
    	document2 = new WorkflowDocument(getPrincipalNameForId("ewestfal"), document2.getRouteHeaderId());
    	assertEquals(appContent2, document.getApplicationContent());
    }
