...
<tiles:useAttribute name="widget" classname="org.kuali.rice.kns.uif.widget.Suggest"/>
<tiles:useAttribute name="parent" classname="org.kuali.rice.kns.uif.field.AttributeField"/>
