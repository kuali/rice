...
/**
 * This is a virtual object representing the {@link DocSearchCriteriaVO} class
 * 
 * @author Kuali Rice Team (kuali-rice@googlegroups.com)
 */
public class DocumentSearchCriteriaVO implements Serializable {
    ...
    private List<KeyValueVO> searchAttributeValues = new ArrayList<KeyValueVO>();
    ...
    public List<KeyValueVO> getSearchAttributeValues() {
        return this.searchAttributeValues;
    }

    public void setSearchAttributeValues(List<KeyValueVO> searchAttributeValues) {
