 ...
 */
package org.kuali.rice.kns.ui.initializer;
...
import org.kuali.rice.kns.ui.field.FieldLabelBase;
...
public class LabelFieldGenerator implements ComponentInitializer {
	 ...
	 * List.
	 * 
	 * @see org.kuali.rice.kns.ui.initializer.ComponentInitializer#initialize(org.kuali.rice.kns.ui.Component,
	 *      java.util.Map)
	 */
	@Override
	public void initialize(Component component, Map<String, String> options) {
		Group group = null;
		...
		for (Component field : group.getItems()) {
			if (field instanceof FieldLabelBase) {
				...
				if (fieldLabel.getLabelField() != null && fieldLabel.isShowLabel()) {
					...
					// set boolean to indicate label field should not be rendered with the attribute
	...
	/**
	 * @see org.kuali.rice.kns.ui.initializer.ComponentInitializer#getSupportedComponents()
	 */
	@Override
