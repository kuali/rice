...
public class ObjectNotABusinessObjectException extends Exception {
    ...
    public ObjectNotABusinessObjectException(String message) {
        super(message);
    }

    public ObjectNotABusinessObjectException(Throwable cause) {
        super(cause);
    }

    public ObjectNotABusinessObjectException(String message, Throwable cause) {
        super(message, cause);
    }
