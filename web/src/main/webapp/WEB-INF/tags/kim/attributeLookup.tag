...
<%@ attribute name="attr" required="true" type="org.kuali.rice.krad.datadictionary.KimDataDictionaryAttributeDefinition" description="The data dictionary definition of the attribute this lookup will help populate." %>
