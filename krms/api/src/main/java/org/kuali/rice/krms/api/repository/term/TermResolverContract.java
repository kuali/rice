 ...
 */
public interface TermResolverContract extends Identifiable, Inactivatable, Versioned {
     ...
     */
    TermSpecificationContract getOutput();
     ...
     */
    Set<? extends TermSpecificationContract> getPrerequisites();
