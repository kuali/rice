 ...
 * to the search engine, effectively allowing for a level of customimzation to the search.</p>
 *
 * <p>This also, includes the ability to defining how results from document lookup should be displayed and processed.
 ...
 * features should be activated by the document lookup framework for a given document type.</p>
 *
