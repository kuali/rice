...
/**
 * The displayMask element specifies the type of masking to be used to hide the value from un-authorized users. There
 * are three types of masking.
 * 
 * @author Kuali Rice Team (rice.collab@kuali.org)
 */
public class DataObjectAttributeMask implements Serializable {
    private static final long serialVersionUID = 4035984416568235531L;

    protected DataObjectAttributeMaskFormatter maskFormatter;
    protected Class<? extends DataObjectAttributeMaskFormatter> maskFormatterClass;
    ...
    public Class<? extends DataObjectAttributeMaskFormatter> getMaskFormatterClass() {
     ...
     */
    public void setMaskFormatterClass(Class<? extends DataObjectAttributeMaskFormatter> maskFormatterClass) {
