...
-- 
insert into trv_acct_fo (acct_fo_id, acct_fo_user_name, obj_id, ver_nbr) values (1, 'fred', sys_guid(), 1)
;
insert into trv_acct_fo (acct_fo_id, acct_fo_user_name, obj_id, ver_nbr) values (2, 'fran', sys_guid(), 1)
;
insert into trv_acct_fo (acct_fo_id, acct_fo_user_name, obj_id, ver_nbr) values (3, 'frank', sys_guid(), 1)
;
insert into TRV_ACCT_TYPE values ('CAT', 'Clearing Account Type', sys_guid(), 1)
;
insert into TRV_ACCT_TYPE values ('EAT', 'Expense Account Type', sys_guid(), 1)
;
insert into TRV_ACCT_TYPE values ('IAT', 'Income Account Type', sys_guid(), 1)
;
insert into TRV_ACCT values ('a1', 'a1', 'CAT', 1, sys_guid(), 1)
;
insert into TRV_ACCT values ('a2', 'a2', 'EAT', 2, sys_guid(), 1)
;
insert into TRV_ACCT values ('a3', 'a3', 'IAT', 3, sys_guid(), 1)
;
insert into TRV_ACCT_EXT values ('a1', 'CAT', sys_guid(), 1)
;
insert into TRV_ACCT_EXT values ('a2', 'EAT', sys_guid(), 1)
;
insert into TRV_ACCT_EXT values ('a3', 'IAT', sys_guid(), 1)
;
