...
/**
 * A plugin registry which loads the embedded plugin and connects to the server using RMI.
...
public class RMIPluginRegistry extends ClientProtocolPluginRegistry {
	...
	public RMIPluginRegistry() {
		super(new QName(Core.getCurrentContextConfig().getMessageEntity(), ResourceLoader.RMI_PLUGIN));
	}
