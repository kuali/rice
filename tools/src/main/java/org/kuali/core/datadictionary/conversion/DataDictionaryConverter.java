...
public class DataDictionaryConverter {
    ...
    private static final List<String> coreFiles = new ArrayList<String>();
    static {
    	coreFiles.add("AdHocRoutePerson.xml");
    	coreFiles.add("AdHocRouteWorkgroup.xml");
    	coreFiles.add("Attachment.xml");
    	coreFiles.add("AttributeReferenceDummy.xml");
    	coreFiles.add("BusinessObjectAttributeEntry.xml");
    	coreFiles.add("Campus.xml");
    	coreFiles.add("CampusMaintenanceDocument.xml");
    	coreFiles.add("CampusType.xml");
    	coreFiles.add("CampusTypeMaintenanceDocument.xml");
    	coreFiles.add("DocumentGroup.xml");
    	coreFiles.add("DocumentHeader.xml");
    	coreFiles.add("DocumentStatus.xml");
    	coreFiles.add("DocumentType.xml");
    	coreFiles.add("DocumentTypeMaintenanceDocument.xml");
    	coreFiles.add("EmployeeStatus.xml");
    	coreFiles.add("EmployeeStatusMaintenanceDocument.xml");
    	coreFiles.add("EmployeeType.xml");
    	coreFiles.add("EmployeeTypeMaintenanceDocument.xml");
    	coreFiles.add("Note.xml");
    	coreFiles.add("NoteType.xml");
    	coreFiles.add("Parameter.xml");
    	coreFiles.add("ParameterDetailType.xml");
    	coreFiles.add("ParameterDetailTypeMaintenanceDocument.xml");
    	coreFiles.add("ParameterNamespace.xml");
    	coreFiles.add("ParameterNamespaceMaintenanceDocument.xml");
    	coreFiles.add("ParameterType.xml");
    	coreFiles.add("ParameterTypeMaintenanceDocument.xml");
    	coreFiles.add("RiceUser.xml");
    	coreFiles.add("RiceUserMaintenanceDocument.xml");
    	coreFiles.add("UniversalUser.xml");
    	coreFiles.add("UniversalUserMaintenanceDocument.xml");
    }
...
//    }
    ...
    public static void main(String[] args) throws Exception {
    	...
    	if (args.length == 1) {
    		...
    		throw new IllegalArgumentException("DataDictionaryConverter can only take one argument specifying a file containing files to convert.  Instead program recieved " + args.length + " arguments.  If specifying a path make sure that spaces in the path are handled properly.");
    	} else {
    		throw new IllegalArgumentException("Please specify a file containing a list of files to convert.");
    	}
        ...
        addCoreFileLocations(fileLocations);
        while (currLine != null) {
    ...
    protected static void addCoreFileLocations(List<String> fileLocations) {
    	for (String coreFileName : coreFiles) {
    		fileLocations.add("classpath:" + PACKAGE_PREFIX + coreFileName);
    	}
    }
