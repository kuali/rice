...
import org.kuali.rice.kew.test.web.framework.actions.AssertAction;
import org.kuali.rice.kew.test.web.framework.actions.EchoAction;
import org.kuali.rice.kew.test.web.framework.actions.ParametersAction;
import org.kuali.rice.kew.test.web.framework.actions.SleepAction;
import org.kuali.rice.kew.test.web.framework.actions.SubmitAction;
import org.kuali.rice.kew.test.web.framework.actions.UserAction;
import org.kuali.rice.kew.test.web.framework.actions.VariableAction;
 ...
 * algorithm defined in {@link org.kuali.rice.kew.test.web.framework.Util#getResolvableAttribute(Node, String, PropertyScheme)}
 * <pre>
 * &lt;script&gt;
 * ... script actions ...
 * &lt;/script&gt;
