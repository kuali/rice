...
public class RoleServiceImplTest extends KIMTestCase {
	...
	private final class RoleServiceTestImpl extends RoleServiceImpl {
		...
		private void assertCachesAreClearedOnUpdatesAsExpected() throws Exception {
			...
			assignPrincipalToRole("p8", "AUTH_SVC_TEST2", "RoleThree", attributeSet);
			...
			assertAndPopulateCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds);
			removePrincipalFromRole("p8", "AUTH_SVC_TEST2", "RoleThree", attributeSet);
			assertCorrectObjectsWereClearedFromCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds, false);
			getBusinessObjectService().findBySinglePrimaryKey(RoleImpl.class, "r3").refreshReferenceObject("members");
			...
			assertAndPopulateCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds);
			removeGroupFromRole("g8", "AUTH_SVC_TEST2", "RoleThree", attributeSet);
			assertCorrectObjectsWereClearedFromCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds, false);
			getBusinessObjectService().findBySinglePrimaryKey(RoleImpl.class, "r3").refreshReferenceObject("members");
			...
			assertAndPopulateCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds);
			removeRoleFromRole("r6", "AUTH_SVC_TEST2", "RoleThree", attributeSet);
			assertCorrectObjectsWereClearedFromCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds, false);
			getBusinessObjectService().findBySinglePrimaryKey(RoleImpl.class, "r3").refreshReferenceObject("members");
			...
			assertAndPopulateCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds);
			saveRoleMemberForRole(null, "p8", "P", "r3", attributeSet, null, null);
			assertCorrectObjectsWereClearedFromCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds, false);
			getBusinessObjectService().findBySinglePrimaryKey(RoleImpl.class, "r3").refreshReferenceObject("members");
			principalRoleMemberId = assertRoleMemberUpdateSucceeded("p8", getStoredRolePrincipalsForPrincipalIdAndRoleIds(oneRoleId, "p8"), true);
			
			assertAndPopulateCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds);
			saveRoleMemberForRole(null, "g8", "G", "r3", attributeSet, null, null);
			assertCorrectObjectsWereClearedFromCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds, false);
			getBusinessObjectService().findBySinglePrimaryKey(RoleImpl.class, "r3").refreshReferenceObject("members");
			groupRoleMemberId = assertRoleMemberUpdateSucceeded("g8", getStoredRoleGroupsForGroupIdsAndRoleIds(oneRoleId, oneGroupId), true);
			
			assertAndPopulateCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds);
			saveRoleMemberForRole(null, "r6", "R", "r3", attributeSet, null, null);
			assertCorrectObjectsWereClearedFromCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds, false);
			getBusinessObjectService().findBySinglePrimaryKey(RoleImpl.class, "r3").refreshReferenceObject("members");
			roleAsMemberRoleMemberId = assertRoleMemberUpdateSucceeded("r6", getStoredRoleMembershipsForRoleIdsAsMembers(oneRoleIdAsMember), true);
			...
			assertAndPopulateCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds);
			saveDelegationMemberForRole(null, principalRoleMemberId, "p6", "P", "P", "r3", attributeSet, null, null);
			assertCorrectObjectsWereClearedFromCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds, false);
			...
			assertAndPopulateCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds);
			saveDelegationMemberForRole(null, principalRoleMemberId, "g7", "G", "P", "r3", attributeSet, null, null);
			assertCorrectObjectsWereClearedFromCache(roleIds, roleMemberIds, delegationIds, delegationMemberIds, false);
			getBusinessObjectService().findBySinglePrimaryKey(KimDelegationImpl.class, delegationId).refreshReferenceObject("members");
