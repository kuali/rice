...
public class EntityResidencyTypeHistoryBo extends EntityResidencyTypeBo implements CodedAttributeHistoryBoContract {
    ...
    public static CodedAttributeHistory to(EntityResidencyTypeHistoryBo bo) {
        if (bo == null) {
            return null;
        }
    ...
    public static EntityResidencyTypeHistoryBo from(CodedAttributeHistory immutable) {
        return CodedAttributeHistoryBoUtil.from(EntityResidencyTypeHistoryBo.class, immutable);
    }

    public static EntityResidencyTypeHistoryBo from(CodedAttribute immutable,
            Timestamp fromDate,
            Timestamp toDate) {
        return CodedAttributeHistoryBoUtil.from(EntityResidencyTypeHistoryBo.class, immutable, fromDate, toDate);
    }
}
