...
public class AttributeReferenceDefinition extends AttributeDefinition {
    ...
    public void setSourceClassName(String sourceClassName) {
        ...
        if ( LOG.isDebugEnabled() ) {
            LOG.debug("calling setSourceClassName '" + sourceClassName + "'");
        }
    ...
    public void setSourceAttributeName(String sourceAttributeName) {
        ...
        if ( LOG.isDebugEnabled() ) {
            LOG.debug("calling setSourceAttributeName '" + sourceAttributeName + "'");
        }
    ...
    public void completeValidation(Class rootObjectClass, Class otherObjectClass, ValidationCompletionUtils validationCompletionUtils) {
        ...
        if (StringUtils.isBlank(sourceClassName)) {
            throw new IllegalArgumentException("invalid (blank) sourceClassName for attribute '" + rootObjectClass.getName() + "." + name + "'");
        }
        if (StringUtils.isBlank(sourceAttributeName)) {
            throw new IllegalArgumentException("invalid (blank) sourceAttributeName for attribute '" + rootObjectClass.getName() + "." + name + "'");
        }
