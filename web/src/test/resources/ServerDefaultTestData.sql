...
;
insert into KRNS_DOC_TYP_T (DOC_TYP_CD, OBJ_ID, VER_NBR, NM, ACTV_IND) values ('TRAV', '1A6FEB2501C7607EE043814FD881607E', 1, 'TRAV ACCNT', 'Y')
;
insert into KRNS_DOC_TYP_T (DOC_TYP_CD, OBJ_ID, VER_NBR, NM, ACTV_IND) values ('TRFO', '1A6FEB250342607EE043814FD881607E', 1, 'TRAV FO', 'Y')
;
insert into KRNS_DOC_TYP_T (DOC_TYP_CD, OBJ_ID, VER_NBR, NM, ACTV_IND) values ('TRD2', '1A6FEB250342607EE043814FD889607E', 1, 'TRAV D2', 'Y')
;
insert into KRNS_DOC_TYP_T (DOC_TYP_CD, OBJ_ID, VER_NBR, NM, ACTV_IND) values ('TRVA', '1A5FEB250342607EE043814FD889607E', 1,  'TRAV MAINT', 'Y')
;
