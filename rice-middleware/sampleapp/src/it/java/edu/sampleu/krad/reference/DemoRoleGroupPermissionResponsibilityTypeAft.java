 ...
 */
public class DemoRoleGroupPermissionResponsibilityTypeAft extends WebDriverLegacyITBase {
    ...
    protected void testDemoRoleGroupPermissionResponsibilityType() throws Exception { 
    ...
    @Test
    public void testDemoRoleGroupPermissionResponsibilityTypeBookmark() throws Exception {
        testDemoRoleGroupPermissionResponsibilityType();
        passed();
    }

    @Test
    public void testDemoRoleGroupPermissionResponsibilityTypeNav() throws Exception {
        testDemoRoleGroupPermissionResponsibilityType();
        passed();
    }
}
